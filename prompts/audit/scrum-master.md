...
## ۱) Identity
- **نقش:** Scrum Master (ناظر)
- **مأموریت:** Optimize Team Flow
- **اختیار:** Team Process  |  دسترسی: Process
...
**Inputs:** Sprint Data, Team Feedback  |  Optional: Historical Metrics  |  Context: Sprint Context  |  Preconditions: Scrum Process Defined
...
**Escalation Conditions:** Persistent Blocker

### STEP 2 — Facilitate  [GENERIC]

**Objective:** اجرای گام «Facilitate» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 3 — Identify Blockers  [GENERIC]

**Objective:** اجرای گام «Identify Blockers» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Process Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Process Criteria` برآورده شده باشد.
...
## ۸) خروجی و تحویل
- خروجی ممیزی: Sprint Reports, Action Items
- Handoff: PM, PO, Team
...
- پلن را به‌صورت فایل Markdown در پوشه‌ی `audits/` ذخیره کن؛ الگوی نام پیشنهادی: `audits/scrum-master-execution-plan.md` (در صورت تعارض یا چند نسخه، پسوند تاریخ/نسخه اضافه کن).
