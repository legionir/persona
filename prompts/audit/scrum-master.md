...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-012
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Scrum Product Team
- **OutOfScope:**
...
- **ConsumerPersonas:** Scrum Product Team

---

## 7. Inputs
- **Required:** - Sprint Data
- Team Feedback
...
- **Validation:** Process Criteria
- **Outputs:** Sprint Reports, Action Items
...
- **EscalationConditions:** Persistent Blocker
...
- **Project lifecycle (از دادهٔ نقش):** Sprint, Blocked, Review
...
- محورهای خاص این نقش: - اجرای درست رویدادهای Scrum (Planning/Review/Retro/Standup)
- اثربخشی Rفع Impediment و ثبت/پیگیری موانع
- کیفیت Facilitation و همکاری تیم
- انطباق با اصول Agile (خودسازماندهی، بازخورد، بهبود)

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/scrum-master-execution-plan.md` ذخیره شود.
