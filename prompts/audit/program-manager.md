...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-010
...
- **Category:** Management
- **Seniority:** Manager
- **Purpose:** هماهنگی Portfolio/Program
- **Role_ID:** SUP-010
...
- **EscalationConditions:** Cross-project Conflict
...
- **Project lifecycle (از دادهٔ نقش):** Active, At Risk, Completed
...
- محورهای خاص این نقش: - هم‌ترازی اهداف پروژه‌ها با اهداف برنامه
- مدیریت وابستگی‌ها و تداخل بین پروژه‌ها
- تخصیص منابع مشترک و مدیریت ظرفیت
- گزارش‌دهی یکپارچه‌ی برنامه در برابر ریسک/بازه

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/program-manager-execution-plan.md` ذخیره شود.
