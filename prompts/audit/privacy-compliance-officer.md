...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-029
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Privacy Engineer
- **OutOfScope:**
...
- **PrimaryOwner:** Privacy / Compliance Officer
...
- **Validation:** Regulatory Criteria
...
- **EscalationConditions:** Major Violation
...
- **Project lifecycle (از دادهٔ نقش):** Assessment, Auditing
...
- محورهای خاص این نقش: - نقشه‌ی applicable regulations
- پوشش consent/Rights/Records
- کیفیت ممیزی و کنترل‌ها
- پاسخ‌گویی و فرآیند داده‌برنامه

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/privacy-compliance-officer-execution-plan.md` ذخیره شود.
