...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-038
...
- **Category:** Commercial
- **Seniority:** Manager
- **Purpose:** توسعه Business Opportunities
- **Role_ID:** SUP-038
...
- **PrimaryOwner:** Business Development Manager
...
- **Generated:** - Partnership Opportunities
...
- **Validation:** Business Criteria
- **Outputs:** Partnership Opportunities
...
- **EscalationConditions:** Strategic Risk
...
- **Project lifecycle (از دادهٔ نقش):** Prospecting, Negotiation
...
- محورهای خاص این نقش: - کیفیت شناسایی فرصت/بستر
- پیگیری/ارزش proposition
- سازگاری با استراتژی و بازار
- اثر و ROI partnership

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/business-development-manager-execution-plan.md` ذخیره شود.
