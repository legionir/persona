...
## ۱) Identity
- **نقش:** Founder / مؤسس (ناظر)
- **مأموریت:** تعیین جهت و هدف نهایی پروژه
- **اختیار:** Vision و تصمیمهای کلان  |  دسترسی: Strategic
...
### STEP 1 — تعریف Vision  [GENERIC]

**Objective:** اجرای گام «تعریف Vision» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Business Idea, Market Need  |  Optional: Research, Financial Data  |  Context: Business, Market, Organization  |  Preconditions: وجود مسئله و فرصت معتبر
...
**Outputs:** Vision, Strategic Decisions

**Evidence:** Market/Business Evidence
...
**Escalation Conditions:** ریسک استراتژیک, تغییر اساسی Scope

### STEP 2 — تعیین اهداف  [GENERIC]

**Objective:** اجرای گام «تعیین اهداف» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 3 — تعیین Constraints  [GENERIC]

**Objective:** اجرای گام «تعیین Constraints» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 4 — تأیید جهت  [GENERIC]

**Objective:** اجرای گام «تأیید جهت» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`اهداف واضح و قابل سنجش`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `اهداف واضح و قابل سنجش` برآورده شده باشد.
...
## ۸) خروجی و تحویل
- خروجی ممیزی: Vision, Strategic Decisions
- Handoff: Product Manager, Sponsor
- Escalation: ریسک استراتژیک, تغییر اساسی Scope

## ۹) Memory
- Strategic Memory, Decisions
...
- پلن را به‌صورت فایل Markdown در پوشه‌ی `audits/` ذخیره کن؛ الگوی نام پیشنهادی: `audits/founder-execution-plan.md` (در صورت تعارض یا چند نسخه، پسوند تاریخ/نسخه اضافه کن).
