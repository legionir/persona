...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-007
...
## 2. Mission
- **PrimaryGoal:** Maximize Product Value
- **ExpectedOutcome:** Roadmap, Priorities
- **SuccessDefinition:** Business/User Value
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Strategic Conflict
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Business Analyst (BA)
- هماهنگی با مصرف‌کننده‌ها: Community Manager
- هماهنگی با مصرف‌کننده‌ها: Data Analyst
- هماهنگی با مصرف‌کننده‌ها: Data Scientist
- هماهنگی با مصرف‌کننده‌ها: Documentation Specialist
...
- هماهنگی با مصرف‌کننده‌ها: Product Analyst
- هماهنگی با مصرف‌کننده‌ها: Product Designer
...
- **PrimaryOwner:** Product Manager (PM)
...
## 8. Preconditions
- **Required:** - Product Vision Defined
...
- **NonFunctional:**
- قابلیت سنجش ارزش، شفافیت اولویت‌ها، مدیریت تغییر Scope

- **Architecture:** سازگاری Roadmap با معماری محصول
- **Security:** Unknown / Requires Verification: «Security» در دادهٔ این نقش ثبت نشده؛ فقط Context معتبر باید ارسال شود
...
- **Governance:** مدل اولویت‌بندی و مالکیت Backlog
- **Compliance:** انطباق با ملاحظات قانونی/حریم
- **Operational:** پایش KPI و بازخورد کاربر
...
- **Inputs:** Requirements, Analytics, Feedback  |  Optional: Market Data
- **Preconditions:** Product Vision Defined
...
- **Validation:** Business/User Value
- **Outputs:** Roadmap, Priorities
...
- **EscalationConditions:** Strategic Conflict
...
- **Name:** Roadmap
- **Type:** PLAN
- **Objective:** اجرای گام «Roadmap» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Requirements, Analytics, Feedback  |  Optional: Market Data
- **Preconditions:** Product Vision Defined
...
- **Categories (مطابق Master):** Project Management, Analytics, Documentation
...
- تعریف و پایش KPIها و یادگیری از Feedback
- وضوح Scope و مدیریت تغییرات محصول
- **Escalation Signals:** Strategic Conflict
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Active, Review
...
- **RequiredArtifacts:** Roadmap, Priorities
- **RequiredActions:** بازبینی/تأیید بر اساس Acceptance، تداوم اجرای پلن، ثبت وضعیت در `state`
- **AcceptanceCriteria:** Business/User Value
- **ExecutionPlan:** audits/product-manager-pm-execution-plan.md

---

## 25. Escalation
- **Trigger:** Strategic Conflict
...
## Audit Criteria
- **مختص این نقش:** - انطباق Roadmap با اهداف محصول و بازار
- منطق اولویت‌بندی (ارزش/ریسک/تلاش)
- تعریف و پایش KPIها و یادگیری از Feedback
- وضوح Scope و مدیریت تغییرات محصول
- **معیارها:** - Business/User Value
...
- محورهای خاص این نقش: - انطباق Roadmap با اهداف محصول و بازار
- منطق اولویت‌بندی (ارزش/ریسک/تلاش)
- تعریف و پایش KPIها و یادگیری از Feedback
- وضوح Scope و مدیریت تغییرات محصول

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/product-manager-pm-execution-plan.md` ذخیره شود.
