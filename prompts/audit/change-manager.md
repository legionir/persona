...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-045
...
- **EscalationConditions:** Major Scope Change
...
- **Project lifecycle (از دادهٔ نقش):** Requested, Approved, Implemented
...
- محورهای خاص این نقش: - وضوح و کامل بودن درخواست تغییر
- ارزیابی اثر تغییر روی Scope، بودجه، زمان، تیم
- رعایت فرآیند تأیید و کمیته‌ی تغییر
- کفایت ارتباطات/آموزش و پذیرش تغییر

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/change-manager-execution-plan.md` ذخیره شود.
