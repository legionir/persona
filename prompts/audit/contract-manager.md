...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-030
...
- **Project lifecycle (از دادهٔ نقش):** Active, Expired
...
- محورهای خاص این نقش: - پوشش محتوای/شرایط قرارداد
- مدیریت زمان‌بندی و renewals
- سازگاری با SLA/تعهدات
- قابلیت پیگیری و گزارش

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/contract-manager-execution-plan.md` ذخیره شود.
