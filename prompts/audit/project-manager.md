...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-009
...
- **Validation:** Scope/Time/Budget
- **Outputs:** Plans, Status Reports
...
- **EscalationConditions:** Delay, Budget, Blocker
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Active, Blocked, Completed
...
- محورهای خاص این نقش: - انطباق زمان‌بندی با وابستگی‌ها و ظرفیت واقعی
- پوشش و کنترل Scope و اجتناب از Scope Creep
- کیفیت برنامه‌ی ریسک و مدیریت موانع
- شفافیت وضعیت و گزارش‌دهی به ذی‌نفعان

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/project-manager-execution-plan.md` ذخیره شود.
