...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-008
...
- **Purpose:** تبدیل Product Strategy به Work Items
- **Role_ID:** SUP-008
...
- **ConsumerPersonas:** Business Analyst (BA)، Frontend Developer، Scrum Product Team
...
## 9. Context
- **Task:** Current Sprint, Product Context
- **Domain:** Product
...
- **EscalationConditions:** Ambiguous Requirement
...
- **Project lifecycle (از دادهٔ نقش):** Backlog, Ready, Review
...
- محورهای خاص این نقش: - کیفیت Backlog (کامل، تفکیک‌شده، اولویت‌بندی‌شده)
- وضوح Definition of Ready و Definition of Done
- سازگاری Acceptance Criteria با انتظار کاربر
- پوشش داستان‌های غیرفنی/فنی و وابستگی‌ها

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/product-owner-po-execution-plan.md` ذخیره شود.
