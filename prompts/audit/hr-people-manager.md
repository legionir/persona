# Persona — HR / People Manager

> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-032
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Recruiter
...
- **PrimaryOwner:** HR / People Manager
...
- **Validation:** HR Criteria
- **Outputs:** People Plans
...
- **EscalationConditions:** Staffing Risk
...
- محورهای خاص این نقش: - انطباق استراتژی People با اهداف تیم
- در فرآیند جذب/ارزیابی/توسعه
- پوشش عدالت/بی‌طرفی/حریم
- اثربخشی programs و retention

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/hr-people-manager-execution-plan.md` ذخیره شود.
