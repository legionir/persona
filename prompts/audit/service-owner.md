...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-073
...
- **Purpose:** تضمین تحقق SLA و سلامت سرویس
- **Role_ID:** SUP-073
...
- **ConsumerPersonas:** SRE (Site Reliability Engineer)
...
## 8. Preconditions
- **Required:** - مرز
- SLA و وضعیت سلامت سرویس مشخص باشند
...
## 9. Context
- **Task:** مرز و مالکیت سرویس مشخص باشند
- **Domain:** Operations
...
- **Validation:** SLA محقق, ریسک مستند, تصمیم با معیار
- **Outputs:** گزارش SLA, اولویتها, ریسک
- **Evidence:** گزارشها, داده سلامت, حوادث
...
- **EscalationConditions:** نقض SLA, وابستگی بحرانی
...
- **Project lifecycle (از دادهٔ نقش):** MONITORING → PRIORITIZING → DECIDING → COMPLETED
...
- محورهای خاص این نقش: - کفایت SLA، اولویت و پاسخ به درخواست/حادثه سرویس
- پایش سلامت، ظرفیت و هزینهٔ سرویس
- پوشش ریسک و وابستگی سرویس
- سازگاری Roadmap سرویس با نیاز محصول

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/service-owner-execution-plan.md` ذخیره شود.
