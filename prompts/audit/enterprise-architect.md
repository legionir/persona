...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-016
...
- **Seniority:** Senior
- **Purpose:** Alignment با Enterprise Architecture
- **Role_ID:** SUP-016
...
- **ConsumerPersonas:** Legacy Modernization Engineer، System Architect
...
- **Validation:** Enterprise Standards
...
- **EscalationConditions:** Strategic Architecture Conflict
...
- محورهای خاص این نقش: - سازگاری با معماری سازمان/استاندارد
- هم‌راستایی با استراتژی و governance
- مدیریت integration/داده
- مناسب/مرور و مسئولیت

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/enterprise-architect-execution-plan.md` ذخیره شود.
