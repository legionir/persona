...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-037
...
- **Validation:** Customer Criteria
- **Outputs:** Account Plan
- **Evidence:** Usage/Contract Evidence
...
- **Project lifecycle (از دادهٔ نقش):** Active, At Risk, Renewed
...
- محورهای خاص این نقش: - کیفیت رابطه/نظرسنجی
- استفاده/رضایت/فرصت
- پوشش escalation/renewal
- سازگاری با محصول/تیم

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/account-manager-execution-plan.md` ذخیره شود.
