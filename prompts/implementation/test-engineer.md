...
## ۱) Identity
- **نقش:** Test Engineer (مجری/اجرا)
- **مأموریت:** کشف Defect
- **اختیار:** Testing  |  دسترسی: Test
...
**Inputs:** Requirements, Build  |  Optional: Logs  |  Context: Test Context  |  Preconditions: Build Available
...
**Escalation Conditions:** Blocking Defect

### STEP 2 — Execute  [GENERIC]

**Objective:** اجرای گام «Execute» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 3 — Record  [GENERIC]

**Objective:** اجرای گام «Record» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Expected vs Actual`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Expected vs Actual` برآورده شده باشد.
