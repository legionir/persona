...
## ۱) Identity
- **نقش:** Technical Writer (مجری/اجرا)
...
**Escalation Conditions:** Missing Information
...
- ورودی‌های الزامی موجود و معتبر باشند (`Accuracy/Completeness`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Accuracy/Completeness` برآورده شده باشد.
