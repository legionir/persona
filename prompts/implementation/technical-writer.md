...
- **Validation:** Accuracy/Completeness
...
- **EscalationConditions:** Missing Information
...
- **Functional:** - Accuracy/Completeness
- **Technical (مختص این نقش):** - تعریف ساختار docs (API/install/guide)
- مستندسازی endpoints/params/examples
- بازبینی اعتبار فنی و version
- تعریف errors/troubleshooting
...
- **Plan Path:** `audits/technical-writer-execution-plan.md` (اگر وجود دارد)
