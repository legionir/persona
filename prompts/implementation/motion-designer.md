...
- **Purpose:** بهبود Interaction Feedback
- **Role_ID:** EXE-049
...
- **Validation:** Performance/UX Criteria
- **Outputs:** Animations
...
- **EscalationConditions:** Performance Risk
...
- **Functional:** - Performance/UX Criteria
- **Technical (مختص این نقش):** - تعریف motion principle/duration/easing
- طراحی transitions/feedback/hover
- رعایت reduced-motion و performance
- تعریف checklist برای motion
...
- **Plan Path:** `audits/motion-designer-execution-plan.md` (اگر وجود دارد)
