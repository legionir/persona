...
## 9. Context
- **Task:** Technical Support Context
- **Domain:** Support
...
- **EscalationConditions:** Production Incident
...
- **Project lifecycle (از دادهٔ نقش):** Investigating, Resolved
...
- **Technical (مختص این نقش):** - تعریف تشخیص اولیه/جمع‌آوری log
- رفع/توصیه/Workaround
- ثبت/بازبینی حل و escalate
- تغذیه docs/knowledge base
...
- **Plan Path:** `audits/technical-support-engineer-execution-plan.md` (اگر وجود دارد)
