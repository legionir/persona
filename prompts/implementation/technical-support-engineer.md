...
## ۱) Identity
- **نقش:** Technical Support Engineer (مجری/اجرا)
- **مأموریت:** رفع Technical Issues
- **اختیار:** Support  |  دسترسی: Restricted
...
### STEP 1 — Reproduce  [GENERIC]

**Objective:** اجرای گام «Reproduce» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Logs, Ticket, Environment  |  Optional: Historical Incidents  |  Context: Technical Support Context  |  Preconditions: Reproducible Issue
...
**Escalation Conditions:** Production Incident

### STEP 2 — Diagnose  [GENERIC]

**Objective:** اجرای گام «Diagnose» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 3 — Fix/Workaround  [GENERIC]

**Objective:** اجرای گام «Fix/Workaround» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- Restricted / Forbidden: Out-of-scope targets

## ۶) Validation
### Definition of Ready / Done / Quality Gates
**Definition of Ready (قبل از شروع):**
- ورودی‌های الزامی موجود و معتبر باشند (`Reproducibility`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Reproducibility` برآورده شده باشد.
