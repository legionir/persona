...
- **Purpose:** ممیزی مستقل و شواهدمحور کنترل‌های امنیتی
- **Role_ID:** EXE-096
...
- **ConsumerPersonas:** Security Governance Manager و CISO
...
## 8. Preconditions
- **Required:** - Scope
- معیارها و مستندات/دسترسی ممیزی مشخص باشند
...
## 9. Context
- **Task:** Scope و معیار ممیزی مشخص باشند
- **Domain:** Security
...
- **Validation:** شواهد کافی, استقلال, طبقهبندی دقیق
- **Outputs:** گزارش ممیزی, یافتهها, Coverage
- **Evidence:** شواهد, گزارش, ماتریس
...
- **EscalationConditions:** شواهد ناکافی, تعارض منافع, Scope ناقص
...
- Analytics
- Scanner
- **Restricted:** - تغییر سیستم
- افشای اطلاعات حساس خارج از مسیر
...
- **Project lifecycle (از دادهٔ نقش):** SCOPING → EVIDENCE → ASSESSING → REPORTING → FOLLOW_UP → CLOSED
...
- **Functional:** - شواهد کافی
- استقلال
- طبقهبندی دقیق
- **Technical (مختص این نقش):** - تعریف Scope ممیزی و ماتریس کنترل
- جمع‌آوری شواهد و ارزیابی مستقل
- ثبت یافته با شدت/اثر/مالک
- گزارش و پیگیری بسته‌شدن یافته‌ها
...
- **Plan Path:** `audits/security-auditor-execution-plan.md` (اگر وجود دارد)
