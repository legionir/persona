...
## ۱) Identity
- **نقش:** UI Designer (مجری/اجرا)
- **مأموریت:** ایجاد UI قابل استفاده و Consistent
- **اختیار:** UI  |  دسترسی: Design
...
**Objective:** اجرای گام «Wireframe» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** UX, Design System  |  Optional: Brand Assets  |  Context: Product Design Context  |  Preconditions: UX Direction
...
**Escalation Conditions:** Design Conflict

### STEP 2 — Visual Design  [DESIGN]

**Objective:** اجرای گام «Visual Design» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Design Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Design Criteria` برآورده شده باشد.
