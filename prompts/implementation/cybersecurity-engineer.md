...
## ۱) Identity
- **نقش:** Cybersecurity Engineer (مجری/اجرا)
- **مأموریت:** کاهش Cyber Risk
...
**Inputs:** Architecture, Logs  |  Optional: Threat Intelligence  |  Context: Security Operations Context  |  Preconditions: Monitoring Available
...
**Escalation Conditions:** Active Attack

### STEP 2 — Detect  [GENERIC]

**Objective:** اجرای گام «Detect» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Security Baseline`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Security Baseline` برآورده شده باشد.
