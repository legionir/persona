...
## ۱) Identity
- **نقش:** Embedded Developer (مجری/اجرا)
- **مأموریت:** اجرای منطق دستگاه
- **اختیار:** Embedded Software  |  دسترسی: Device
...
**Escalation Conditions:** Hardware Failure
...
- ورودی‌های الزامی موجود و معتبر باشند (`Hardware/Functional Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Hardware/Functional Criteria` برآورده شده باشد.
