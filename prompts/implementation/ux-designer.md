...
## ۱) Identity
- **نقش:** UX Designer (مجری/اجرا)
- **مأموریت:** ایجاد User Experience مناسب
- **اختیار:** UX  |  دسترسی: Design
...
**Inputs:** User Research, Requirements  |  Optional: Analytics  |  Context: User Context  |  Preconditions: User Problem Defined
...
**Escalation Conditions:** Usability Risk

### STEP 2 — Flow  [GENERIC]

**Objective:** اجرای گام «Flow» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Usability Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Usability Criteria` برآورده شده باشد.
