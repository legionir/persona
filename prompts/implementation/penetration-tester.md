...
## ۱) Identity
- **نقش:** Penetration Tester (مجری/اجرا)
- **مأموریت:** شناسایی قابلسوءاستفاده بودن آسیبپذیریها
- **اختیار:** Authorized Scope  |  دسترسی: Restricted
...
### STEP 1 — Scope  [GENERIC]

**Objective:** اجرای گام «Scope» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Scope, Targets  |  Optional: Architecture  |  Context: Pentest Context  |  Preconditions: Explicit Authorization
...
### STEP 2 — Recon  [GENERIC]

**Objective:** اجرای گام «Recon» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Evidence/Reproducibility`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Evidence/Reproducibility` برآورده شده باشد.
...
- Handoff: AppSec, Security Architect
