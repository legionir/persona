...
## ۱) Identity
- **نقش:** Observability Engineer (مجری/اجرا)
- **مأموریت:** قابل مشاهدهکردن System Health
- **اختیار:** Observability  |  دسترسی: Observability
...
### STEP 1 — Instrument  [GENERIC]

**Objective:** اجرای گام «Instrument» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Architecture, SLOs  |  Optional: Incident History  |  Context: Production Context  |  Preconditions: Monitoring Stack
...
**Escalation Conditions:** Blind Spot

### STEP 2 — Collect  [GENERIC]
...
### STEP 3 — Correlate  [GENERIC]

**Objective:** اجرای گام «Correlate» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 4 — Alert  [GENERIC]

**Objective:** اجرای گام «Alert» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Signal Quality`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Signal Quality` برآورده شده باشد.
