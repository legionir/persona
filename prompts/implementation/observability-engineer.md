...
- **Seniority:** Senior
- **Purpose:** قابل مشاهده‌کردن System Health
- **Role_ID:** EXE-075
...
- **Project lifecycle (از دادهٔ نقش):** Instrumenting, Monitoring
...
- **Technical (مختص این نقش):** - تعریف instrumented code/log/metric/trace
- پیاده‌سازی metrics/dashboards/alerts
- مدیریت correlation/context
- تعریف SLO/Error budget و انباشته
...
- **Plan Path:** `audits/observability-engineer-execution-plan.md` (اگر وجود دارد)
