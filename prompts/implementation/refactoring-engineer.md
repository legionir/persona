...
## ۱) Identity
- **نقش:** Refactoring Engineer (مجری/اجرا)
- **مأموریت:** کاهش Technical Debt
- **اختیار:** Codebase  |  دسترسی: Repository
...
**Inputs:** Code, Technical Debt  |  Optional: Metrics  |  Context: Code Context  |  Preconditions: Tests Available
...
**Escalation Conditions:** Regression

### STEP 2 — Refactor  [GENERIC]

**Objective:** اجرای گام «Refactor» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Behavior Preserved`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Behavior Preserved` برآورده شده باشد.
