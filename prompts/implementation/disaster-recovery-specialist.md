...
## ۱) Identity
- **نقش:** Disaster Recovery Specialist (مجری/اجرا)
- **مأموریت:** Recover System After Disaster
- **اختیار:** Disaster Recovery  |  دسترسی: Restricted
...
**Inputs:** Architecture, Backup  |  Optional: Incident History  |  Context: DR Context  |  Preconditions: Backup/Recovery Available
...
**Escalation Conditions:** Recovery Failure
...
- ورودی‌های الزامی موجود و معتبر باشند (`RTO/RPO`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `RTO/RPO` برآورده شده باشد.
