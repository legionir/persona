...
## ۱) Identity
- **نقش:** Mobile Developer (مجری/اجرا)
- **مأموریت:** پیادهسازی Mobile Product
- **اختیار:** Mobile  |  دسترسی: Repository (Mobile)
...
**Inputs:** Designs, API Contracts  |  Optional: Platform Guidelines  |  Context: Mobile Context  |  Preconditions: Mobile Requirements
...
**Escalation Conditions:** Platform Blocker
...
- Restricted / Forbidden: Production (no credentials/secrets exposure)

## ۶) Validation
### Definition of Ready / Done / Quality Gates
**Definition of Ready (قبل از شروع):**
- ورودی‌های الزامی موجود و معتبر باشند (`Platform Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Platform Criteria` برآورده شده باشد.
