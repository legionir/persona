...
## ۱) Identity
- **نقش:** Customer Support Agent (مجری/اجرا)
...
- ورودی‌های الزامی موجود و معتبر باشند (`SLA/Accuracy`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `SLA/Accuracy` برآورده شده باشد.
...
- Handoff: Technical Support, Product
