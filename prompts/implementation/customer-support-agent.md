...
- گزارش کیفیت/نظرسنجی
- **Supporting:**
- هماهنگی با ناظر: Customer Success Manager
...
- **PrimaryOwner:** Customer Support Agent
- **DecisionOwner:** Customer Success Manager
- **ImplementationOwner:** Customer Support Agent
- **Reviewer:** Customer Success Manager، Operations Manager
- **Approver:** Customer Success Manager، Operations Manager
- **SupportingPersonas:** Customer Success Manager، Operations Manager
- **ConsumerPersonas:** Technical Support, Product
...
- **Validation:** SLA/Accuracy
- **Outputs:** Resolution, Ticket
...
- **EscalationConditions:** Critical Issue
...
- **Project lifecycle (از دادهٔ نقش):** Open, Investigating, Resolved
...
- **Functional:** - SLA/Accuracy
- **Technical (مختص این نقش):** - تعریف flow/اسکریپت/FAQ پایه
- پاسخ/تشخیص/اسکالیشن/رفع مشکلات
- ثبت ticket و مستندات/نتیجه
- گزارش کیفیت/نظرسنجی
...
- **Plan Path:** `audits/customer-support-agent-execution-plan.md` (اگر وجود دارد)
