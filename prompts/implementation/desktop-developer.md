...
## ۱) Identity
- **نقش:** Desktop Developer (مجری/اجرا)
- **مأموریت:** تولید Desktop Application
- **اختیار:** Desktop  |  دسترسی: Repository
...
**Inputs:** Requirements, Design  |  Optional: OS Documentation  |  Context: Desktop Context  |  Preconditions: Requirements Ready
...
**Escalation Conditions:** OS Compatibility Issue
...
- ورودی‌های الزامی موجود و معتبر باشند (`Functional/Platform Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Functional/Platform Criteria` برآورده شده باشد.
