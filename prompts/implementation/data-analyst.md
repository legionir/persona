...
- **Supporting:**
- هماهنگی با ناظر: Product Analyst Lead
...
- **Reviewer:** Product Analyst Lead، Product Manager (PM)
- **Approver:** Product Analyst Lead، Product Manager (PM)
- **SupportingPersonas:** Product Analyst Lead، Product Manager (PM)
...
- **EscalationConditions:** Data Quality Issue
...
- **Project lifecycle (از دادهٔ نقش):** Analysis, Reporting
...
- **Technical (مختص این نقش):** - تعریف مرجع metric/data/schema
- تحلیل behavior/funnel/segment
- گزارش analysis and recommendations
- ارتباط با product/engineering
...
- **Plan Path:** `audits/data-analyst-execution-plan.md` (اگر وجود دارد)
