...
## ۱) Identity
- **نقش:** Database Administrator (DBA) (مجری/اجرا)
- **مأموریت:** Availability و Integrity دیتابیس
- **اختیار:** Database Operations  |  دسترسی: Database
...
**Inputs:** DB Config, Access Policies  |  Optional: Historical Metrics  |  Context: Database Context  |  Preconditions: DB Available
...
**Escalation Conditions:** Data Loss Risk
...
**Objective:** اجرای گام «Tune» با حفظ Scope و بدون تغییر خارج از اختیار.
...
**Objective:** اجرای گام «Restore Test» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Availability/Integrity`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Availability/Integrity` برآورده شده باشد.
