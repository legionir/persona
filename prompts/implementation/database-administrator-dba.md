...
- **Purpose:** Availability و Integrity دیتابیس
- **Role_ID:** EXE-021
...
- **Validation:** Availability/Integrity
- **Outputs:** DB Config, Backup
- **Evidence:** DB Logs
...
- **EscalationConditions:** Data Loss Risk
...
- **Project lifecycle (از دادهٔ نقش):** Monitoring, Maintenance
...
- **Functional:** - Availability/Integrity
- **Technical (مختص این نقش):** - تعریف access/ssl/audit
- مدیریت backup/restore/و DR
- پایش performance/wait/locks
- بازبینی query/index/storage
...
- **Plan Path:** `audits/database-administrator-dba-execution-plan.md` (اگر وجود دارد)
