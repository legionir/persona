...
- **Validation:** Accuracy/Consistency
- **Outputs:** Prompts, Evaluation Results
- **Evidence:** Test Cases
...
- **EscalationConditions:** Model Limitation
...
- **Project lifecycle (از دادهٔ نقش):** Draft, Testing, Approved
...
- **Functional:** - Accuracy/Consistency
- **Technical (مختص این نقش):** - تعریف task/context/few-shot/reference
- طراحی prompt و variables
- سنجش quality/safety/evaluation
- تکرار prompt experiments و نگهداری نسخه
...
- **Plan Path:** `audits/prompt-engineer-execution-plan.md` (اگر وجود دارد)
