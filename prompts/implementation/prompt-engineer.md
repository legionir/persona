...
## ۱) Identity
- **نقش:** Prompt Engineer (مجری/اجرا)
- **مأموریت:** بهینهسازی رفتار مدل
- **اختیار:** Prompt Layer  |  دسترسی: AI/ML
...
**Inputs:** Task Definition, Model  |  Optional: Examples  |  Context: AI Context  |  Preconditions: Model Available
...
**Escalation Conditions:** Model Limitation

### STEP 2 — Prompt  [GENERIC]

**Objective:** اجرای گام «Prompt» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Accuracy/Consistency`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Accuracy/Consistency` برآورده شده باشد.
