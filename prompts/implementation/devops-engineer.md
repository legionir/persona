...
- **PrimaryOwner:** DevOps Engineer
- **DecisionOwner:** Technical Lead / Tech Lead
- **ImplementationOwner:** DevOps Engineer
- **Reviewer:** Technical Lead / Tech Lead، Cloud Architect
- **Approver:** Technical Lead / Tech Lead، Cloud Architect
- **SupportingPersonas:** Technical Lead / Tech Lead، Cloud Architect
- **ConsumerPersonas:** SRE, Developers
...
- **Validation:** Repeatable/Safe Deployment
...
- **EscalationConditions:** Deployment Failure
...
- **Project lifecycle (از دادهٔ نقش):** Building, Deploying, Running
...
- **Functional:** - Repeatable/Safe Deployment
- **Technical (مختص این نقش):** - تعریف CI/CD (jobs، env، gates، caching)
- تعریف IaC و مدیریت Secret/Configuration
- تعریف Rollback/Canary/Blue-Green
- تعریف Monitoring/Alerting برای Pipeline
...
- **Plan Path:** `audits/devops-engineer-execution-plan.md` (اگر وجود دارد)
