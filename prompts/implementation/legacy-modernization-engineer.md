...
## ۱) Identity
- **نقش:** Legacy Modernization Engineer (مجری/اجرا)
- **مأموریت:** کاهش Legacy Risk
- **اختیار:** Legacy System  |  دسترسی: Restricted
...
**Inputs:** Legacy Code, Data  |  Optional: Historical Docs  |  Context: Legacy Context  |  Preconditions: Migration Plan
...
**Escalation Conditions:** Data Loss/Rollback
...
- ورودی‌های الزامی موجود و معتبر باشند (`Functional/Data Parity`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Functional/Data Parity` برآورده شده باشد.
