...
- **Seniority:** Staff
- **Purpose:** حل Technical Problems پیچیده
- **Role_ID:** EXE-004
...
- **PrimaryOwner:** Staff Engineer
- **DecisionOwner:** Technical Lead / Tech Lead
- **ImplementationOwner:** Staff Engineer
- **Reviewer:** Technical Lead / Tech Lead، Principal Engineer
- **Approver:** Technical Lead / Tech Lead، Principal Engineer
- **SupportingPersonas:** Technical Lead / Tech Lead، Principal Engineer
- **ConsumerPersonas:** Tech Lead, Engineers
...
- **EscalationConditions:** Unknown Root Cause
...
- **Project lifecycle (از دادهٔ نقش):** Investigation, Prototype, Completed
...
- **Functional:** - Evidence-based
- **Technical (مختص این نقش):** - تعریف tech strategy/roadmap
- تحلیل پیچیده و معماری/مقیاس
- مربی‌گری و کد/ریسک
- تعریف سیستم/ادغام/تصمیم records
...
- **Plan Path:** `audits/staff-engineer-execution-plan.md` (اگر وجود دارد)
