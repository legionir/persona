...
## ۱) Identity
- **نقش:** Third-party Integration Specialist (مجری/اجرا)
- **مأموریت:** اتصال پایدار سرویسها
- **اختیار:** Integration Layer  |  دسترسی: Integration
...
### STEP 1 — Study  [GENERIC]

**Objective:** اجرای گام «Study» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** API Docs, Credentials  |  Optional: Sandbox Data  |  Context: Integration Context  |  Preconditions: External API Available
...
**Escalation Conditions:** API Breaking Change
...
- ورودی‌های الزامی موجود و معتبر باشند (`Contract/Security Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Contract/Security Criteria` برآورده شده باشد.
