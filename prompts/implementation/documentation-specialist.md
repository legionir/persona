...
- **EscalationConditions:** Ambiguity
...
- **Project lifecycle (از دادهٔ نقش):** Draft, Review, Published
...
- **Functional:** - User Comprehension
- **Technical (مختص این نقش):** - تعریف ساختار docs و style guide
- تألیف user guides/FAQ/quickstart
- بازبینی accuracy و UX doc
- مدیریت نگهداری و دسترس‌پذیری
...
- **Plan Path:** `audits/documentation-specialist-execution-plan.md` (اگر وجود دارد)
