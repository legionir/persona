...
## ۱) Identity
- **نقش:** Translator (مجری/اجرا)
- **مأموریت:** ترجمه دقیق و طبیعی
- **اختیار:** Assigned Language  |  دسترسی: Content
...
### STEP 1 — Translate  [GENERIC]

**Objective:** اجرای گام «Translate» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Source Content  |  Optional: Glossary  |  Context: Language Context  |  Preconditions: Source Stable
...
**Escalation Conditions:** Ambiguous Source
...
- ورودی‌های الزامی موجود و معتبر باشند (`Accuracy/Terminology`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Accuracy/Terminology` برآورده شده باشد.
