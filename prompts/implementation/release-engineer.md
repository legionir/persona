...
## ۱) Identity
- **نقش:** Release Engineer (مجری/اجرا)
- **مأموریت:** انتشار کنترلشده نرمافزار
- **اختیار:** Release Process  |  دسترسی: Release
...
**Inputs:** Build, Test Results  |  Optional: Release History  |  Context: Release Context  |  Preconditions: QA Approved
...
**Escalation Conditions:** Failed Gate

### STEP 2 — Package  [GENERIC]
...
### STEP 3 — Version  [GENERIC]

**Objective:** اجرای گام «Version» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 4 — Release  [GENERIC]

**Objective:** اجرای گام «Release» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Release Checklist`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Release Checklist` برآورده شده باشد.
