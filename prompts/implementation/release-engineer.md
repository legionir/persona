...
- **Seniority:** Senior
- **Purpose:** انتشار کنترل‌شده نرم‌افزار
- **Role_ID:** EXE-029
...
- **EscalationConditions:** Failed Gate
...
- **Project lifecycle (از دادهٔ نقش):** Preparing, Released, Rolled Back
...
- **Technical (مختص این نقش):** - تعریف versioning/artefact/sign
- پیاده‌سازی release pipeline + gates
- مدیریت rollout/rollback/canary
- تعریف changelog/release notes
...
- **Plan Path:** `audits/release-engineer-execution-plan.md` (اگر وجود دارد)
