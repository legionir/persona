...
## ۱) Identity
- **نقش:** Security Engineer (مجری/اجرا)
- **مأموریت:** کاهش Security Risk
- **اختیار:** Security Implementation  |  دسترسی: Security
...
**Inputs:** Security Requirements, Architecture  |  Optional: Findings  |  Context: Security Context  |  Preconditions: Security Design Available
...
- ورودی‌های الزامی موجود و معتبر باشند (`Security Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Security Criteria` برآورده شده باشد.
