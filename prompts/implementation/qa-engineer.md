...
## ۱) Identity
- **نقش:** QA Engineer (مجری/اجرا)
- **مأموریت:** تضمین کیفیت محصول
- **اختیار:** QA  |  دسترسی: Test
...
**Inputs:** Requirements, Build  |  Optional: Bug History  |  Context: Product/Test Context  |  Preconditions: Testable Build
...
**Escalation Conditions:** Critical Defect

### STEP 2 — Design Tests  [DESIGN]

**Objective:** اجرای گام «Design Tests» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Acceptance Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Acceptance Criteria` برآورده شده باشد.
