...
- **Purpose:** جذب و فعال‌سازی کاربران
- **Role_ID:** EXE-065

---

## 2. Mission
- **PrimaryGoal:** جذب و فعالسازی کاربران
- **ExpectedOutcome:** Campaigns, Reports
- **SuccessDefinition:** KPI Criteria
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Campaign Failure
...
- هماهنگی با ناظر: Growth Manager
- **OutOfScope:**
...
- **PrimaryOwner:** Marketing Specialist
- **DecisionOwner:** Product Marketing Manager
- **ImplementationOwner:** Marketing Specialist
- **Reviewer:** Product Marketing Manager، Growth Manager
- **Approver:** Product Marketing Manager، Growth Manager
- **SupportingPersonas:** Product Marketing Manager، Growth Manager
- **ConsumerPersonas:** Growth, PM
...
- **Inputs:** Marketing Plan  |  Optional: Analytics
...
- **EscalationConditions:** Campaign Failure

### STEP 2 — Create  [IMPLEMENT]
- **ID:** STEP-2
- **Name:** Create
- **Type:** IMPLEMENT
- **Objective:** اجرای گام «Create» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Marketing Plan  |  Optional: Analytics
- **Preconditions:** Campaign Approved
...
- پایش performance و A/B
- گزارش الهام/آموزش و iteration
- **Escalation Signals:** Campaign Failure
...
- **Project lifecycle (از دادهٔ نقش):** Draft, Live, Completed

---

## 24. Handoff
- **PrimaryRecipient:** Growth, PM
- **SupportingRecipients:** Product Marketing Manager, Growth Manager
- **DecisionOwner:** Product Marketing Manager
- **ImplementationOwner:** Marketing Specialist
- **RequiredArtifacts:** Campaigns, Reports
- **RequiredActions:** بازبینی/تأیید بر اساس Acceptance، تداوم اجرای پلن، ثبت وضعیت در `state`
- **AcceptanceCriteria:** KPI Criteria
- **ExecutionPlan:** audits/marketing-specialist-execution-plan.md
...
## 26. Execution Plan
- **Path:** audits/marketing-specialist-execution-plan.md
...
- **Functional:** - KPI Criteria
- **Technical (مختص این نقش):** - تعریف campaign objective/audience/copy
- اجرای channel execution
- پایش performance و A/B
- گزارش الهام/آموزش و iteration
...
- **Plan Path:** `audits/marketing-specialist-execution-plan.md` (اگر وجود دارد)
