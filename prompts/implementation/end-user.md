...
- **Category:** Support
- **Seniority:** Junior
- **Purpose:** ایجاد Signal واقعی از Product Usage
- **Role_ID:** EXE-061
...
- **Supporting:**
- هماهنگی با ناظر: Product Owner پس از Release
- **OutOfScope:**
...
- **PrimaryOwner:** End User
- **DecisionOwner:** Product Owner پس از Release
- **ImplementationOwner:** End User
- **Reviewer:** Product Owner پس از Release
- **Approver:** Product Owner پس از Release
- **SupportingPersonas:** Product Owner پس از Release
- **ConsumerPersonas:** Support, Product
...
- **EscalationConditions:** Critical User Issue
...
- **Project lifecycle (از دادهٔ نقش):** Active
...
- **Functional:** - User Satisfaction
- **Technical (مختص این نقش):** - تعیین اهداف/day-to-day استفاده
- ثبت مشکلات/فریکشن/کارایی
- گزارش به تیم/مسیر
- امنیت/اطلاعات/رعایت انطباق
...
- **Plan Path:** `audits/end-user-execution-plan.md` (اگر وجود دارد)
