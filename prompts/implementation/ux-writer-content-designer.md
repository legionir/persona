# Persona — UX Writer / Content Designer

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-046
...
- **Seniority:** Mid
- **Purpose:** ایجاد Clear Product Communication
- **Role_ID:** EXE-046
...
- **PrimaryOwner:** UX Writer / Content Designer
...
- **Validation:** Clarity/Consistency
- **Outputs:** Copy
...
- **EscalationConditions:** Ambiguous Copy
...
- **Functional:** - Clarity/Consistency
- **Technical (مختص این نقش):** - تعریف voice/tone/word guide
- نوشتن copy برای Error/Empty/Success/CTA
- بازبینی یکدستی UI copy در همه‌جا
- ارزیابی clarity/action/ایمپکت
...
- **Plan Path:** `audits/ux-writer-content-designer-execution-plan.md` (اگر وجود دارد)
