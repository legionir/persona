...
## ۱) Identity
- **نقش:** Network Engineer (مجری/اجرا)
- **مأموریت:** تضمین Connectivity
- **اختیار:** Network  |  دسترسی: Network
...
**Inputs:** Network Architecture  |  Optional: Traffic Data  |  Context: Network Context  |  Preconditions: Network Plan
...
**Escalation Conditions:** Network Failure
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Connectivity/Security` برآورده شده باشد.
...
- Handoff: Security, Infrastructure
- Escalation: Network Failure
