...
- **ConsumerPersonas:** Marketing, Mobile
...
- **Validation:** ASO Criteria
- **Outputs:** Store Assets, Reports
...
- **EscalationConditions:** Store Policy Risk
...
- **Project lifecycle (از دادهٔ نقش):** Draft, Testing, Published
...
- **Functional:** - ASO Criteria
- **Technical (مختص این نقش):** - تعریف keywords/title/subtitle/screenshots
- بهینه‌سازی metadata و creative
- مدیریت reviews/replies و conversion
- گزارش A/B و install
...
- **Plan Path:** `audits/aso-specialist-execution-plan.md` (اگر وجود دارد)
