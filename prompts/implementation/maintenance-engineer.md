...
## ۱) Identity
- **نقش:** Maintenance Engineer (مجری/اجرا)
- **مأموریت:** حفظ سلامت سیستم
...
**Inputs:** Issues, Code  |  Optional: Logs  |  Context: Maintenance Context  |  Preconditions: Issue Reproducible
...
**Escalation Conditions:** Critical Regression
...
**Objective:** اجرای گام «Fix» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Regression Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Regression Criteria` برآورده شده باشد.
