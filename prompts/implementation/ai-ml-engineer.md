...
- **Category:** Data
- **Seniority:** Senior
- **Purpose:** ساخت و Integration مدل
- **Role_ID:** EXE-015
...
- **PrimaryOwner:** AI/ML Engineer
- **DecisionOwner:** AI Engineer Lead
- **ImplementationOwner:** AI/ML Engineer
- **Reviewer:** AI Engineer Lead، Principal Engineer
- **Approver:** AI Engineer Lead، Principal Engineer
- **SupportingPersonas:** AI Engineer Lead، Principal Engineer
- **ConsumerPersonas:** AI Lead, Backend
...
- **Validation:** Accuracy/Latency Criteria
...
- **EscalationConditions:** Poor Model Performance
...
- **Project lifecycle (از دادهٔ نقش):** Training, Evaluation, Deployment
...
- **Functional:** - Accuracy/Latency Criteria
- **Technical (مختص این نقش):** - تعریف features/dataset/metric
- پیاده‌سازی training/eval/inference
- مدیریت model/data versioning
- پیاده‌سازی monitor/drift/guardrail
...
- **Plan Path:** `audits/ai-ml-engineer-execution-plan.md` (اگر وجود دارد)
