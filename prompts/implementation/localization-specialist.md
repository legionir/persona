...
## ۱) Identity
- **نقش:** Localization Specialist (مجری/اجرا)
- **مأموریت:** تطبیق محصول با بازار هدف
...
**Escalation Conditions:** Cultural Conflict
...
- ورودی‌های الزامی موجود و معتبر باشند (`Locale Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Locale Criteria` برآورده شده باشد.
