...
## ۱) Identity
- **نقش:** Build Engineer (مجری/اجرا)
- **مأموریت:** تولید Artifact قابل انتشار
- **اختیار:** Build System  |  دسترسی: Repository
...
### STEP 1 — Resolve  [GENERIC]

**Objective:** اجرای گام «Resolve» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Source Code, Dependencies  |  Optional: Cache  |  Context: Build Context  |  Preconditions: Source Valid
