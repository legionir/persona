...
## ۱) Identity
- **نقش:** Deployment Engineer (مجری/اجرا)
- **مأموریت:** Deploy Safe and Repeatable
- **اختیار:** Deployment  |  دسترسی: Restricted
...
### STEP 1 — Precheck  [TEST]

**Objective:** اجرای گام «Precheck» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Release Artifact, Environment  |  Optional: Deployment History  |  Context: Environment Context  |  Preconditions: Release Approved
...
### STEP 5 — Rollback if Needed  [GENERIC]

**Objective:** اجرای گام «Rollback if Needed» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Deployment Checklist`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Deployment Checklist` برآورده شده باشد.
