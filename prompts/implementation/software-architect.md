...
## ۱) Identity
- **نقش:** Software Architect (مجری/اجرا)
- **مأموریت:** طراحی ساختار داخلی نرمافزار
- **اختیار:** Software Architecture  |  دسترسی: Repository
...
**Inputs:** Requirements, Solution Architecture  |  Optional: Existing Code  |  Context: Codebase Context  |  Preconditions: Requirements Available
...
**Evidence:** Code/Architecture Evidence
...
### STEP 2 — Decompose  [GENERIC]

**Objective:** اجرای گام «Decompose» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Maintainability, Scalability`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Maintainability, Scalability` برآورده شده باشد.
