...
## ۱) Identity
- **نقش:** System Architect (مجری/اجرا)
- **مأموریت:** طراحی System-level Architecture
- **اختیار:** System  |  دسترسی: System
...
**Inputs:** Requirements, Constraints  |  Optional: Existing Infrastructure  |  Context: System Context  |  Preconditions: Requirements Available
...
**Escalation Conditions:** Integration Risk
...
- ورودی‌های الزامی موجود و معتبر باشند (`Integration Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Integration Criteria` برآورده شده باشد.
...
- Handoff: Solution Architect, Engineering
