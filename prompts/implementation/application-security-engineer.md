...
## ۱) Identity
- **نقش:** Application Security Engineer (مجری/اجرا)
- **مأموریت:** کشف و کاهش Application Vulnerabilities
- **اختیار:** Application  |  دسترسی: Security & Test
...
**Inputs:** Source Code, Architecture  |  Optional: Dependency Reports  |  Context: AppSec Context  |  Preconditions: Code Available
...
**Escalation Conditions:** Critical Vulnerability
...
**Objective:** اجرای گام «Exploit Validation» با حفظ Scope و بدون تغییر خارج از اختیار.
...
**Objective:** اجرای گام «Verify Fix» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Evidence + Severity`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Evidence + Severity` برآورده شده باشد.
...
- Handoff: Developers, Security Architect
