...
- **Category:** Security
- **Seniority:** Senior
- **Purpose:** کشف و کاهش Application Vulnerabilities
- **Role_ID:** EXE-037
...
- **PrimaryOwner:** Application Security Engineer
...
- **ConsumerPersonas:** Developers, Security Architect
...
## 10. Memory
- **Working:** - Security Findings Memory
...
- **Validation:** Evidence + Severity
- **Outputs:** Findings, Remediation Tasks
- **Evidence:** Code/Scan Evidence
...
- **Project lifecycle (از دادهٔ نقش):** Scanning, Review, Retest
...
- **Functional:** - Evidence + Severity
- **Technical (مختص این نقش):** - پیاده‌سازی input validation/output encoding
- امنیت session/authz/CSRF/XSS/SQLi
- secure error/exception و لاگ عدم افشا
- تعریف security code review و tests
...
- **Plan Path:** `audits/application-security-engineer-execution-plan.md` (اگر وجود دارد)
