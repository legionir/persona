...
- **Category:** Testing
- **Seniority:** Senior
- **Purpose:** Automate Quality Verification
- **Role_ID:** EXE-033

---

## 2. Mission
- **PrimaryGoal:** Automate Quality Verification
- **ExpectedOutcome:** Automated Test Suite
- **SuccessDefinition:** Stability/Repeatability
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Flaky Tests
...
- **PrimaryOwner:** Test Automation Engineer
- **DecisionOwner:** QA Lead
- **ImplementationOwner:** Test Automation Engineer
- **Reviewer:** QA Lead، DevOps Manager
- **Approver:** QA Lead، DevOps Manager
- **SupportingPersonas:** QA Lead، DevOps Manager
- **ConsumerPersonas:** QA, DevOps
...
- **Generated:** - Automated Test Suite
...
- **API:**
- پوشش لایه‌ها و قراردادها در تست
- **Data:**
- کیس‌های امنیتی در استراتژی تست
- **Security:**
- کیس‌های امنیتی در استراتژی تست
- **Performance:**
- تست بار/کارایی
- **Compatibility:**
- پوشش نسخه‌ها/مرورگرها/پلتفرم‌ها
- **Testing:**
...
- **Inputs:** Requirements, Test Cases  |  Optional: Existing Framework
- **Preconditions:** Stable Test Interface
...
- **Validation:** Stability/Repeatability
- **Outputs:** Automated Test Suite
- **Evidence:** Test Logs
...
- **EscalationConditions:** Flaky Tests
...
- **Name:** Run
- **Type:** VALIDATE
- **Objective:** اجرای گام «Run» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Requirements, Test Cases  |  Optional: Existing Framework
- **Preconditions:** Stable Test Interface
...
### STEP 4 — Maintain  [VALIDATE]
- **ID:** STEP-4
- **Name:** Maintain
- **Type:** VALIDATE
- **Objective:** اجرای گام «Maintain» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Requirements, Test Cases  |  Optional: Existing Framework
- **Preconditions:** Stable Test Interface
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Categories (مطابق Master):** Testing, Browser DevTools, Load Testing, Profiler, Documentation

---

## 16. Evidence & Verification
- **Evidence لازم:** - Test Logs
...
- اتصال به CI و reporting
- مدیریت flaky tests و رگرسیون خودکار
- **Escalation Signals:** Flaky Tests
...
- **Project lifecycle (از دادهٔ نقش):** Development, Running

---

## 24. Handoff
- **PrimaryRecipient:** QA, DevOps
- **SupportingRecipients:** QA Lead, DevOps Manager
- **DecisionOwner:** QA Lead
- **ImplementationOwner:** Test Automation Engineer
- **RequiredArtifacts:** Automated Test Suite
- **RequiredActions:** بازبینی/تأیید بر اساس Acceptance، تداوم اجرای پلن، ثبت وضعیت در `state`
- **AcceptanceCriteria:** Stability/Repeatability
- **ExecutionPlan:** audits/test-automation-engineer-execution-plan.md
...
- **TargetPersona:** QA Lead, DevOps Manager
...
## 26. Execution Plan
- **Path:** audits/test-automation-engineer-execution-plan.md
...
- **Functional:** - Stability/Repeatability
- **Technical (مختص این نقش):** - انتخاب framework و ساختار (page objects)
- نوشتن تست‌های maintained و data-isolated
- اتصال به CI و reporting
- مدیریت flaky tests و رگرسیون خودکار
...
- **Plan Path:** `audits/test-automation-engineer-execution-plan.md` (اگر وجود دارد)
