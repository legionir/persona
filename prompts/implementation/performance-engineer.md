...
- **EscalationConditions:** Performance Regression
...
- **Project lifecycle (از دادهٔ نقش):** Testing, Optimization
...
- **Functional:** - SLA/SLO Criteria
- **Technical (مختص این نقش):** - تعریف workload/durations/sizes و baseline
- اجرای load/stress/spike test
- تحلیل bottleneck و recommending optimizations
- گزارش Performance و compare
...
- **Plan Path:** `audits/performance-engineer-execution-plan.md` (اگر وجود دارد)
