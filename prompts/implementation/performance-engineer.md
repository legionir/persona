...
## ۱) Identity
- **نقش:** Performance Engineer (مجری/اجرا)
...
- ورودی‌های الزامی موجود و معتبر باشند (`SLA/SLO Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `SLA/SLO Criteria` برآورده شده باشد.
