...
- **Purpose:** انتقال بدون Loss/Corruption
- **Role_ID:** EXE-080
...
- **PrimaryOwner:** Migration Specialist
...
- **ConsumerPersonas:** DBA, QA, DevOps
...
- **EscalationConditions:** Data Loss
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Migration, Validation, Cutover
...
- **Functional:** - Data Parity
- **Technical (مختص این نقش):** - تعریف source/target/mapping/validation
- پیاده‌سازی migration + dry run
- مدیریت cutover/backup/rollback
- تست validation data + resume
...
- **Plan Path:** `audits/migration-specialist-execution-plan.md` (اگر وجود دارد)
