...
## ۱) Identity
- **نقش:** Migration Specialist (مجری/اجرا)
- **مأموریت:** انتقال بدون Loss/Corruption
- **اختیار:** Migration  |  دسترسی: Restricted
...
**Objective:** اجرای گام «Map» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Source/Target Schema  |  Optional: Historical Data  |  Context: Migration Context  |  Preconditions: Migration Plan Approved
...
**Escalation Conditions:** Data Loss

### STEP 2 — Transform  [IMPLEMENT]

**Objective:** اجرای گام «Transform» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 5 — Reconcile  [GENERIC]

**Objective:** اجرای گام «Reconcile» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 6 — Cutover  [GENERIC]

**Objective:** اجرای گام «Cutover» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Data Parity`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Data Parity` برآورده شده باشد.
