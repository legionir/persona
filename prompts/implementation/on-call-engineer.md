...
## ۱) Identity
- **نقش:** On-call Engineer (مجری/اجرا)
- **مأموریت:** Restore Service
- **اختیار:** Assigned Service  |  دسترسی: Restricted
...
### STEP 1 — Detect  [GENERIC]

**Objective:** اجرای گام «Detect» با حفظ Scope و بدون تغییر خارج از اختیار.

**Inputs:** Alerts, Logs  |  Optional: Runbooks  |  Context: Production Service Context  |  Preconditions: Alert Triggered
...
**Escalation Conditions:** Critical/Unknown Issue
...
- ورودی‌های الزامی موجود و معتبر باشند (`SLO Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `SLO Criteria` برآورده شده باشد.
