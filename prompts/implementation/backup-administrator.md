# Persona — Backup Administrator

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-083
...
- **PrimaryOwner:** Backup Administrator
- **DecisionOwner:** Business Continuity Manager
- **ImplementationOwner:** Backup Administrator
- **Reviewer:** Business Continuity Manager
- **Approver:** Business Continuity Manager
- **SupportingPersonas:** Business Continuity Manager
- **ConsumerPersonas:** DBA, DR
...
- **Validation:** Recovery Criteria
- **Outputs:** Backup Status, Restore Evidence
...
- **EscalationConditions:** Backup Failure
...
- **Project lifecycle (از دادهٔ نقش):** Running, Failed, Verified
...
- **Technical (مختص این نقش):** - تعریف scope/schedule/retention
- مدیریت backup/jobs/monitoring
- تست restore و رفع خطا
- تعریف alert/alarm و report
...
- **Plan Path:** `audits/backup-administrator-execution-plan.md` (اگر وجود دارد)
