...
## ۱) Identity
- **نقش:** Procurement Specialist (مجری/اجرا)
- **مأموریت:** تأمین منابع موردنیاز
- **اختیار:** Procurement  |  دسترسی: Procurement
...
**Escalation Conditions:** Procurement Risk
...
- ورودی‌های الزامی موجود و معتبر باشند (`Cost/Requirement Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Cost/Requirement Criteria` برآورده شده باشد.
