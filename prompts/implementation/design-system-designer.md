...
## ۱) Identity
- **نقش:** Design System Designer (مجری/اجرا)
...
- ورودی‌های الزامی موجود و معتبر باشند (`Consistency/Accessibility`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Consistency/Accessibility` برآورده شده باشد.
