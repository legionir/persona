# Persona — Design System Designer

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-047
...
- **Purpose:** ایجاد Consistent UI System
- **Role_ID:** EXE-047
...
- **PrimaryOwner:** Design System Designer
- **DecisionOwner:** Design Manager
- **ImplementationOwner:** Design System Designer
- **Reviewer:** Design Manager، Technical Lead / Tech Lead
- **Approver:** Design Manager، Technical Lead / Tech Lead
- **SupportingPersonas:** Design Manager، Technical Lead / Tech Lead
...
- **Validation:** Consistency/Accessibility
- **Outputs:** Components, Guidelines
...
- **EscalationConditions:** Breaking Change
...
- **Project lifecycle (از دادهٔ نقش):** Draft, Published, Deprecated
...
- **Functional:** - Consistency/Accessibility
- **Technical (مختص این نقش):** - تعریف tokens (color/typography/spacing/radius)
- تعریف component library و states/variants
- تعریف docs/usage و versioning
- تعریف governance/contribution برای design system
...
- **Plan Path:** `audits/design-system-designer-execution-plan.md` (اگر وجود دارد)
