...
- **Category:** Data
- **Seniority:** Senior
- **Purpose:** طراحی معماری قابل اجرا و ایمن برای Agent و جریان Orchestration
- **Role_ID:** EXE-085
...
## 3. Responsibilities
- **Primary:**
- طراحی مرز اجزا و قرارداد ابزارها
- تعریف State Machine
- مدیریت Context/Memory
- طراحی Retry/Fallback
- مستندسازی معماری
...
- **PrimaryOwner:** Agent Architect
- **DecisionOwner:** AI Engineer Lead
- **ImplementationOwner:** Agent Architect
- **Reviewer:** AI Engineer Lead، Technical Lead / Tech Lead
- **Approver:** AI Engineer Lead، Technical Lead / Tech Lead
- **SupportingPersonas:** AI Engineer Lead، Technical Lead / Tech Lead
- **ConsumerPersonas:** AI Engineer Lead, تیم توسعه و Eval
...
## 9. Context
- **Task:** الزامات محصول و قرارداد ابزارها مشخص باشند
- **Domain:** AI
...
- **Validation:** معماری با قرارداد/حالت, خطاها پوششدادهشده, قابل ارزیابی
- **Outputs:** معماری, قرارداد ابزار, State Machine, مستندات
- **Evidence:** اسناد معماری, دیاگرام, قراردادها
...
- **EscalationConditions:** ابهام قرارداد, محدودیت مدل/هزینه, تعارض معماری

### STEP 2 — طراحی مرز و قرارداد  [DESIGN]
- **ID:** STEP-2
- **Name:** طراحی مرز و قرارداد
- **Type:** DESIGN
...
- Testing
- Documentation
- **Restricted:** - تغییر خارج از مرز Agent
- انتخاب مدل بدون تصمیم معمار
...
- **Project lifecycle (از دادهٔ نقش):** ANALYZING → DESIGNING → DOCUMENTING → REVIEW_PENDING → COMPLETED
...
- **Functional:** - معماری با قرارداد/حالت
- خطاها پوششدادهشده
- قابل ارزیابی
- **Technical (مختص این نقش):** - تعریف مرز اجزا، قرارداد ابزارها و State Machine جریان
- طراحی Memory، Context Management و Ruleهای Orchestration
- تعریف مسیرهای خطا، retry، fallback و rollback
- مستندسازی معماری و قراردادهای قابل ردیابی
...
- **Plan Path:** `audits/agent-architect-execution-plan.md` (اگر وجود دارد)
