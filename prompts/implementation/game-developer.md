...
## ۱) Identity
- **نقش:** Game Developer (مجری/اجرا)
- **مأموریت:** تولید Game Systems
- **اختیار:** Game Systems  |  دسترسی: Repository
...
**Inputs:** Game Design, Assets  |  Optional: Analytics  |  Context: Game Context  |  Preconditions: Game Design Ready
...
**Escalation Conditions:** Critical Gameplay Issue
...
**Objective:** اجرای گام «Playtest» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Gameplay/Performance Criteria`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Gameplay/Performance Criteria` برآورده شده باشد.
