...
## ۱) Identity
- **نقش:** Firmware Engineer (مجری/اجرا)
- **مأموریت:** کنترل Hardware از طریق Firmware
- **اختیار:** Firmware  |  دسترسی: Device
...
**Inputs:** Hardware Specs  |  Optional: Datasheets  |  Context: Hardware Context  |  Preconditions: Board Available
...
**Escalation Conditions:** Hardware Risk
...
### STEP 3 — Compile  [GENERIC]

**Objective:** اجرای گام «Compile» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 4 — Flash  [GENERIC]

**Objective:** اجرای گام «Flash» با حفظ Scope و بدون تغییر خارج از اختیار.
...
### STEP 5 — Debug  [GENERIC]

**Objective:** اجرای گام «Debug» با حفظ Scope و بدون تغییر خارج از اختیار.
...
- ورودی‌های الزامی موجود و معتبر باشند (`Hardware Validation`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Hardware Validation` برآورده شده باشد.
