...
## ۱) Identity
- **نقش:** System Administrator (مجری/اجرا)
- **مأموریت:** سلامت سیستمهای پایه
- **اختیار:** Systems  |  دسترسی: Server
...
**Inputs:** Infrastructure Requirements  |  Optional: Logs  |  Context: System Context  |  Preconditions: Server Available
...
**Escalation Conditions:** Critical System Issue

### STEP 2 — Patch  [GENERIC]
...
- ورودی‌های الزامی موجود و معتبر باشند (`Availability/Security`).
...
- خروجی‌ها و شواهد ثبت شده باشند؛ معیار پذیرش `Availability/Security` برآورده شده باشد.
...
- Handoff: Infrastructure, Security
