...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-049
...
- **Validation:** SLA Criteria
- **Outputs:** Vendor Report
...
- **EscalationConditions:** SLA Breach
...
- **Project lifecycle (از دادهٔ نقش):** Active, At Risk, Terminated
...
- محورهای خاص این نقش: - کیفیت قرارداد/SLA و انطباق با الزامات
- ارزیابی عملکرد و ریسک تأمین‌کننده
- مدیریت هزینه و رابطه/استراتژی Vendor
- ترک Vendor و شیوه‌ی خروج (Exit)

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/vendor-manager-execution-plan.md` ذخیره شود.
