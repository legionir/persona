...
- **Purpose:** استخراج Insight و Predictive Model
- **Role_ID:** EXE-016
...
- **PrimaryOwner:** Data Scientist
- **DecisionOwner:** Data Architect
- **ImplementationOwner:** Data Scientist
- **Reviewer:** Data Architect، Product Manager (PM)
- **Approver:** Data Architect، Product Manager (PM)
- **SupportingPersonas:** Data Architect، Product Manager (PM)
- **ConsumerPersonas:** PM, Data Engineer
...
- **Validation:** Statistical Validity
...
- **EscalationConditions:** Insufficient Data
...
- **Project lifecycle (از دادهٔ نقش):** Analysis, Modeling
...
- **Functional:** - Statistical Validity
- **Technical (مختص این نقش):** - تعریف problem/data/evaluation
- انجام EDA/feature/model/validation
- سنجش metrics/cross-validation
- گزارش insight/ریسک و deploy readiness
...
- **Plan Path:** `audits/data-scientist-execution-plan.md` (اگر وجود دارد)
