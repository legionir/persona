...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-021
...
- **Project lifecycle (از دادهٔ نقش):** Strategy, Review
...
- محورهای خاص این نقش: - کیفیت دیدگاه فنی سازمانی
- سازگاری با اجرا/تجربه
- مدیریت پیچیدگی/Trade-off
- تأثیر بر راه‌حل‌ها/تیم

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/principal-engineer-execution-plan.md` ذخیره شود.
