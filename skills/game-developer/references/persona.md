...
- **Project lifecycle (از دادهٔ نقش):** Development, Playtest, Release
...
- **Technical (مختص این نقش):** - تعریف gameplay loop/state machine
- پیاده‌سازی mechanics/event/entity
- مدیریت perf/memory/input/device
- تست gameplay/perf/بازخورد
...
- **Plan Path:** `audits/game-developer-execution-plan.md` (اگر وجود دارد)
