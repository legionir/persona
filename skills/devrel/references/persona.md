...
- **Purpose:** رشد Developer Ecosystem
- **Role_ID:** EXE-069

---

## 2. Mission
- **PrimaryGoal:** رشد Developer Ecosystem
- **ExpectedOutcome:** Tutorials, Feedback Reports
- **SuccessDefinition:** Developer Criteria
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Major Developer Issue
...
- **Reviewer:** Community Director، Product Marketing Manager
- **Approver:** Community Director، Product Marketing Manager
- **SupportingPersonas:** Community Director، Product Marketing Manager
- **ConsumerPersonas:** Product, Engineering
...
- **Name:** Educate
- **Type:** VALIDATE
- **Objective:** اجرای گام «Educate» با حفظ Scope و بدون تغییر خارج از Authority.
...
- **Validation:** Developer Criteria
- **Outputs:** Tutorials, Feedback Reports
...
- **EscalationConditions:** Major Developer Issue

### STEP 2 — Engage  [VALIDATE]
- **ID:** STEP-2
- **Name:** Engage
- **Type:** VALIDATE
- **Objective:** اجرای گام «Engage» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Product, Developer Feedback  |  Optional: Analytics
- **Preconditions:** Developer Product Available
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Type:** VALIDATE
- **Objective:** اجرای گام «Collect Feedback» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Product, Developer Feedback  |  Optional: Analytics
- **Preconditions:** Developer Product Available
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Project lifecycle (از دادهٔ نقش):** Active, Event
...
- **Functional:** - Developer Criteria
- **Technical (مختص این نقش):** - تعریف developer persona/content plan
- نوشتن docs/tutorials/امتحان
- شرکت در community/events/امتحان
- جمع‌بندی feedback و community growth
...
- **Plan Path:** `audits/devrel-execution-plan.md` (اگر وجود دارد)
