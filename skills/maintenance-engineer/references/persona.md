...
- **PrimaryOwner:** Maintenance Engineer
...
- **Validation:** Regression Criteria
- **Outputs:** Patch, Tests
...
- **EscalationConditions:** Critical Regression
...
- **Project lifecycle (از دادهٔ نقش):** Assigned, Fixing, Verified
...
- **Technical (مختص این نقش):** - تعریف triage/repro/root cause
- اعمال fix + tests + regression
- مدیریت release/hotfix/backport
- جامعه‌ی مشاهدات/known issues
...
- **Plan Path:** `audits/maintenance-engineer-execution-plan.md` (اگر وجود دارد)
