...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-036
...
- سازگاری با تیم/برند
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Sales Representative
- **OutOfScope:**
...
- **Validation:** Revenue Criteria
- **Outputs:** Sales Plan
- **Evidence:** CRM Evidence
...
- **EscalationConditions:** Revenue Risk
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Active
...
- محورهای خاص این نقش: - کیفیت pipeline/prospecting/forecast
- انطباق فرآیند با محصول/مخاطب
- شفافیت deals/stage/risk
- سازگاری با تیم/برند

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/sales-manager-execution-plan.md` ذخیره شود.
