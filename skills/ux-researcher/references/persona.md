...
- هماهنگی با ناظر: Design Manager
- **OutOfScope:**
...
- **Reviewer:** Product Manager (PM)، Design Manager
- **Approver:** Product Manager (PM)، Design Manager
- **SupportingPersonas:** Product Manager (PM)، Design Manager
- **ConsumerPersonas:** Product, UX
...
- **Validation:** Methodological Validity
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Research, Analysis
...
- **Functional:** - Methodological Validity
- **Technical (مختص این نقش):** - تعریف research plan/objectives/method
- اجرای interviews/surveys/usability
- تحلیل qualitative/quantitative شواهد
- گزارش insight با توصیه و ذینفعان
...
- **Plan Path:** `audits/ux-researcher-execution-plan.md` (اگر وجود دارد)
