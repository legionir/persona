...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-039
...
- **Category:** Commercial
- **Seniority:** Manager
- **Purpose:** ایجاد Partnership پایدار
- **Role_ID:** SUP-039
...
- **PrimaryOwner:** Partnership Manager
...
- **Validation:** SLA/Business Criteria
- **Outputs:** Partnership Status
- **Evidence:** Contract/Performance Evidence
...
- **EscalationConditions:** Partner Risk
...
- **Project lifecycle (از دادهٔ نقش):** Negotiation, Active, Terminated
...
- محورهای خاص این نقش: - انطباق با استراتژی/ارزش دوطرفه
- پوشش کانال/سرویس/قرارداد
- مدیریت ROI/انگیزه/محتوای
- کیفیت رابطه/پیگیری

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/partnership-manager-execution-plan.md` ذخیره شود.
