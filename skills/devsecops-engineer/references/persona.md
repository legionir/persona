...
## 2. Mission
- **PrimaryGoal:** Automated Security Verification
- **ExpectedOutcome:** Security Pipeline, Findings
- **SuccessDefinition:** Security Gate Criteria
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Critical Finding
...
- **PrimaryOwner:** DevSecOps Engineer
- **DecisionOwner:** Security Architect
- **ImplementationOwner:** DevSecOps Engineer
- **Reviewer:** Security Architect، DevOps Manager
- **Approver:** Security Architect، DevOps Manager
- **SupportingPersonas:** Security Architect، DevOps Manager
- **ConsumerPersonas:** Developers, Security
...
## 10. Memory
- **Working:** - Security Pipeline Memory
...
- **Inputs:** Repository, Pipeline  |  Optional: Security Policies
- **Preconditions:** CI/CD Available
...
- **Validation:** Security Gate Criteria
- **Outputs:** Security Pipeline, Findings
...
- **EscalationConditions:** Critical Finding

### STEP 2 — Scan  [VALIDATE]
- **ID:** STEP-2
- **Name:** Scan
- **Type:** VALIDATE
- **Objective:** اجرای گام «Scan» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Repository, Pipeline  |  Optional: Security Policies
- **Preconditions:** CI/CD Available
...
### STEP 3 — Gate  [VALIDATE]
- **ID:** STEP-3
- **Name:** Gate
- **Type:** VALIDATE
- **Objective:** اجرای گام «Gate» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Repository, Pipeline  |  Optional: Security Policies
- **Preconditions:** CI/CD Available
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
### STEP 5 — Remediate  [VALIDATE]
- **ID:** STEP-5
- **Name:** Remediate
- **Type:** VALIDATE
- **Objective:** اجرای گام «Remediate» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Repository, Pipeline  |  Optional: Security Policies
- **Preconditions:** CI/CD Available
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Allowed:** - CI/CD
- Security Scanners
- **Restricted:** - Security gates (no bypass)
...
- **Project lifecycle (از دادهٔ نقش):** Scanning, Blocked, Passed

---

## 24. Handoff
- **PrimaryRecipient:** Developers, Security
- **SupportingRecipients:** Security Architect, DevOps Manager
- **DecisionOwner:** Security Architect
- **ImplementationOwner:** DevSecOps Engineer
- **RequiredArtifacts:** Security Pipeline, Findings
- **RequiredActions:** بازبینی/تأیید بر اساس Acceptance، تداوم اجرای پلن، ثبت وضعیت در `state`
- **AcceptanceCriteria:** Security Gate Criteria
- **ExecutionPlan:** audits/devsecops-engineer-execution-plan.md
...
- **TargetPersona:** Security Architect, DevOps Manager
...
## 26. Execution Plan
- **Path:** audits/devsecops-engineer-execution-plan.md
...
- **Functional:** - Security Gate Criteria
- **Technical (مختص این نقش):** - تعریف security checks در pipeline
- پیاده‌سازی SAST/DAST/dependency scan
- مدیریت secrets و گیت‌های امنیتی
- تعریف reporting/compliance
...
- **Plan Path:** `audits/devsecops-engineer-execution-plan.md` (اگر وجود دارد)
