...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-014
...
- **Category:** Management
- **Seniority:** Manager
- **Purpose:** هماهنگی Technical Delivery
- **Role_ID:** SUP-014
...
- **PrimaryOwner:** Technical Project Manager
...
- **EscalationConditions:** Critical Technical Risk
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Active, Blocked
...
- محورهای خاص این نقش: - وضوح تصمیم‌های فنی و تأثیر آنها روی زمان/منابع
- استدلال صحیح در تخمین/ریسک فنی
- هماهنگی بین تیم فنی و ذی‌نفعان غیرفنی
- پوشش Dependencies فنی و آماده‌سازی Infrastructure

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/technical-project-manager-execution-plan.md` ذخیره شود.
