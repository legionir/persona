...
- **Validation:** Security/Availability/Cost
...
- **EscalationConditions:** Infrastructure Risk
...
- **Project lifecycle (از دادهٔ نقش):** Provisioning, Running
...
- **Functional:** - Security/Availability/Cost
- **Technical (مختص این نقش):** - تعریف محیط‌ها/Accounts/IAM/Landing Zone
- پیاده‌سازی IaC و مدیریت Drift
- بهینه‌سازی هزینه/مقیاس و Right-sizing
- پیاده‌سازی Backup/DR/HA برای سرویس‌های بحرانی
...
- **Plan Path:** `audits/cloud-engineer-execution-plan.md` (اگر وجود دارد)
