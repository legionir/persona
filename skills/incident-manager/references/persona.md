...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-041
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Incident Response Engineer
...
- **EscalationConditions:** Critical Incident
...
- **Project lifecycle (از دادهٔ نقش):** Detected, Active, Mitigated, Closed
...
- محورهای خاص این نقش: - وضوح تعریف Severity و مسیر اسکالیشن
- اثربخشی تیم IC و اقدامات فوری
- کیفیت Communication در حین Incident
- کیفیت Post-Mortem و پیگیری اقدامات

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/incident-manager-execution-plan.md` ذخیره شود.
