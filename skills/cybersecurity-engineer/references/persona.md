# Persona — Cybersecurity Engineer

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-038
...
- هماهنگی با ناظر: Security Governance Manager
- **OutOfScope:**
...
- **PrimaryOwner:** Cybersecurity Engineer
- **DecisionOwner:** Chief Information Security Officer (CISO)
- **ImplementationOwner:** Cybersecurity Engineer
- **Reviewer:** Chief Information Security Officer (CISO)، Security Governance Manager
- **Approver:** Chief Information Security Officer (CISO)، Security Governance Manager
- **SupportingPersonas:** Chief Information Security Officer (CISO)، Security Governance Manager
- **ConsumerPersonas:** SOC, Incident Manager
...
## 9. Context
- **Task:** Security Operations Context
- **Domain:** Security
...
- **Outputs:** Security Status, Incidents
...
- **EscalationConditions:** Active Attack
...
- **Project lifecycle (از دادهٔ نقش):** Monitoring, Incident
...
- **Functional:** - Security Baseline
- **Technical (مختص این نقش):** - تعریف defense-in-depth و control layers
- پیاده‌سازی monitoring/threat detection
- مدیریت Incident response و playbook
- تعریف baseline/hardening و پچ
...
- **Plan Path:** `audits/cybersecurity-engineer-execution-plan.md` (اگر وجود دارد)
