...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-033
...
- **Category:** Support
- **Seniority:** Manager
- **Purpose:** Maximize Customer Value
- **Role_ID:** SUP-033
...
- **PrimaryOwner:** Customer Success Manager
...
- **ConsumerPersonas:** Customer Support Agent
...
- **EscalationConditions:** Churn Risk
...
- **Project lifecycle (از دادهٔ نقش):** Onboarding, Active, At Risk
...
- محورهای خاص این نقش: - سلامت حساب/استفاده/retention
- کفایت onboarding و ارزش‌آفرینی
- مدیریت churn/risk/expand
- سازگاری با محصول/تیم

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/customer-success-manager-execution-plan.md` ذخیره شود.
