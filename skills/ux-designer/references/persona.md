...
- **Purpose:** ایجاد User Experience مناسب
- **Role_ID:** EXE-043
...
- **PrimaryOwner:** UX Designer
- **DecisionOwner:** Design Manager
- **ImplementationOwner:** UX Designer
- **Reviewer:** Design Manager، Product Manager (PM)
- **Approver:** Design Manager، Product Manager (PM)
- **SupportingPersonas:** Design Manager، Product Manager (PM)
- **ConsumerPersonas:** UI, Product
...
- **Validation:** Usability Criteria
- **Outputs:** UX Designs, Flows
- **Evidence:** User Test Evidence
...
- **EscalationConditions:** Usability Risk
...
- **Project lifecycle (از دادهٔ نقش):** Research, Prototype, Approved
...
- **Functional:** - Usability Criteria
- **Technical (مختص این نقش):** - تعریف user flows و journey
- طراحی Feedback/error/undo policies
- طراحی IA/navigation و terminology
- ارزیابی با a11y و task completion
...
- **Plan Path:** `audits/ux-designer-execution-plan.md` (اگر وجود دارد)
