...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-013
...
- **Purpose:** Improve Organizational Agility
- **Role_ID:** SUP-013
...
- **Validation:** Measurable Improvement
...
- **EscalationConditions:** Organizational Resistance
...
- **Project lifecycle (از دادهٔ نقش):** Assessment, Coaching, Review
...
- محورهای خاص این نقش: - میزان رعایت ارزش‌ها/اصول Agile در عمل
- اثرگذاری coaching بر رفتار تیم‌ها
- کیفیت آموزش/مستندات و Adoption
- پایش improvement (cycle time، handoff، blockages)

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/agile-coach-execution-plan.md` ذخیره شود.
