...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-044
...
- **Project lifecycle (از دادهٔ نقش):** Assessment, Monitoring
...
- محورهای خاص این نقش: - کامل بودن شناسایی ریسک‌ها (فنی، مالی، زمانی، سازمانی)
- دقت امتیازدهی احتمال/اثر
- اثربخشی برنامه‌های کاهش و پاسخ
- به‌روز بودن و گزارش‌دهی ریسک در طول پروژه

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/risk-manager-execution-plan.md` ذخیره شود.
