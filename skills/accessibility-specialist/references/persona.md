...
- **PrimaryOwner:** Accessibility Specialist
- **DecisionOwner:** Design Manager
- **ImplementationOwner:** Accessibility Specialist
- **Reviewer:** Design Manager، QA Lead
- **Approver:** Design Manager، QA Lead
- **SupportingPersonas:** Design Manager، QA Lead
- **ConsumerPersonas:** Frontend, QA
...
- **EscalationConditions:** Critical Accessibility Issue
...
- **Project lifecycle (از دادهٔ نقش):** Auditing, Retest
...
- **Technical (مختص این نقش):** - تعریف a11y acceptance و checklist
- رعایت semantic HTML, aria, alt, labels
- manage focus/modal/keyboard
- تدوین a11y تست و بازبینی
...
- **Plan Path:** `audits/accessibility-specialist-execution-plan.md` (اگر وجود دارد)
