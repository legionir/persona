...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-035
...
- **Category:** Commercial
- **Seniority:** Manager
- **Purpose:** افزایش Sustainable Growth
- **Role_ID:** SUP-035
...
- **Validation:** Statistical Criteria
- **Outputs:** Growth Experiments
...
- **EscalationConditions:** Growth Risk
...
- **Project lifecycle (از دادهٔ نقش):** Hypothesis, Running, Completed
...
- محورهای خاص این نقش: - وضوح north-star/فانل/حفظ
- پوشش experiments/prioritization
- سازگاری با product/مخاطب
- قابلیت measurement و یادگیری

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/growth-manager-execution-plan.md` ذخیره شود.
