...
- **Category:** Analysis
- **Seniority:** Senior
- **Purpose:** تبدیل Business Need به Requirement
- **Role_ID:** EXE-001
...
- **Validation:** Complete, Unambiguous, Testable
...
- **EscalationConditions:** Conflicting Requirements
...
- **Role-specific rules:**
- Accept/Reject/Clarify Requirement
...
- **Project lifecycle (از دادهٔ نقش):** Discovery, Analysis, Review, Completed
...
- Unambiguous
- Testable
- **Technical (مختص این نقش):** - استخراج Functional/Non-functional/Data Requirements
- نوشتن User Story با Acceptance Criteria و Edge Cases
- ترسیم As-Is و To-Be و Gap Analysis
- تعریف ماتریس ردیابی نیازمندی ↔ خروجی/تست
...
- **Plan Path:** `audits/business-analyst-ba-execution-plan.md` (اگر وجود دارد)
