...
- **Seniority:** Mid
- **Purpose:** تحویل End-to-End قابلیت
- **Role_ID:** EXE-008
...
- **PrimaryOwner:** Full-Stack Developer
...
- **Validation:** Functional/Technical Criteria
...
- **EscalationConditions:** Cross-layer Conflict
...
- **Project lifecycle (از دادهٔ نقش):** Development, Testing, Review
...
- **Functional:** - Functional/Technical Criteria
- **Technical (مختص این نقش):** - تعریف contract/data flow/end-to-end
- پیاده‌سازی backend + frontend با توافقات
- مدیریت auth/session/optimization
- تست integration/E2E + documentation
...
- **Plan Path:** `audits/full-stack-developer-execution-plan.md` (اگر وجود دارد)
