...
- **Purpose:** ایجاد UI قابل استفاده و Consistent
- **Role_ID:** EXE-042
...
- **EscalationConditions:** Design Conflict
...
- **Technical (مختص این نقش):** - استخراج Design Tokens و الگوهای UI
- طراحی وضعیت‌ها/ریسپانسیو و grid
- رعایت contrast/focus/semantics
- استفاده از Reusable Components/توکن
...
- **Plan Path:** `audits/ui-designer-execution-plan.md` (اگر وجود دارد)
