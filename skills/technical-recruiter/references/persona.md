...
## 3. Responsibilities
- **Primary:**
- Technical Screening Coordination
...
- **Generated:** - Candidate Assessment
...
- **Validation:** Technical Criteria
- **Outputs:** Candidate Assessment
...
- **EscalationConditions:** Skill Gap
...
- **Project lifecycle (از دادهٔ نقش):** Screening, Assessment
...
- **Technical (مختص این نقش):** - تعریف مهارت‌ها/تست فنی/rubric
- شرکت در technical screening و ارزیابی
- هماهنگی با team/lead
- مدیریت candidate data و feedback
...
- **Plan Path:** `audits/technical-recruiter-execution-plan.md` (اگر وجود دارد)
