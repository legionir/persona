...
- **Supporting:**
- هماهنگی با ناظر: Infrastructure Manager
...
- **Reviewer:** Infrastructure Manager، Security Architect
- **Approver:** Infrastructure Manager، Security Architect
- **SupportingPersonas:** Infrastructure Manager، Security Architect
- **ConsumerPersonas:** Infrastructure, Security
...
- **Validation:** Availability/Security
...
- **EscalationConditions:** Critical System Issue
...
- **Project lifecycle (از دادهٔ نقش):** Active, Maintenance
...
- **Functional:** - Availability/Security
- **Technical (مختص این نقش):** - تعریف استاندارد Server hardening و کاربر
- تعریف اتوماسیون (scripts/ansible) و Config
- تعریف پایش پایه، لاگ و alert
- تعریف backup/restore و test
...
- **Plan Path:** `audits/system-administrator-execution-plan.md` (اگر وجود دارد)
