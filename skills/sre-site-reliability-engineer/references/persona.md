...
- **PrimaryOwner:** SRE (Site Reliability Engineer)
- **DecisionOwner:** Service Owner
- **ImplementationOwner:** SRE (Site Reliability Engineer)
- **Reviewer:** Service Owner، Engineering Manager
- **Approver:** Service Owner، Engineering Manager
- **SupportingPersonas:** Service Owner، Engineering Manager
...
- **Project lifecycle (از دادهٔ نقش):** Monitoring, Incident, Recovery
...
- **Functional:** - SLO/SLA Criteria
- **Technical (مختص این نقش):** - تعریف SLOs/SLIs و Error Budget
- تعریف Monitoring/Alerting/Incident Flow
- تعریف Capacity/Baseline/Performance را
- تعریف چرخه‌ی بهبود و Postmortem
...
- **Plan Path:** `audits/sre-site-reliability-engineer-execution-plan.md` (اگر وجود دارد)
