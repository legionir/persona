...
- **Category:** Support
- **Seniority:** Mid
- **Purpose:** کشف مشکلات قبل از Release
- **Role_ID:** EXE-060
...
- **EscalationConditions:** Critical Bug
...
- **Technical (مختص این نقش):** - دریافت access/جست‌وجو/استفاده
- اجرای flows و ثبت issues
- یافته با info (build/step/evidence)
- بازخورد به تیم/حفظ کیفیت
...
- **Plan Path:** `audits/beta-tester-execution-plan.md` (اگر وجود دارد)
