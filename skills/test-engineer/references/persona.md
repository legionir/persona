...
## 2. Mission
- **PrimaryGoal:** کشف Defect
- **ExpectedOutcome:** Test Results
- **SuccessDefinition:** Expected vs Actual
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Blocking Defect
...
- **EscalationConditions:** Blocking Defect
...
- **Name:** Record
- **Type:** VALIDATE
- **Objective:** اجرای گام «Record» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Requirements, Build  |  Optional: Logs
- **Preconditions:** Build Available
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Project lifecycle (از دادهٔ نقش):** Testing, Failed, Passed
...
- **Functional:** - Expected vs Actual
- **Technical (مختص این نقش):** - تهیهی Test Data و Environment setup
- اجرای تست‌های functional/technical و رگرسیون
- مستندسازی results و evidence
- ارتباط با dev/PM برای triage
...
- **Plan Path:** `audits/test-engineer-execution-plan.md` (اگر وجود دارد)
