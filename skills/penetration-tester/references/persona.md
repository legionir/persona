...
- **Category:** Security
- **Seniority:** Mid
- **Purpose:** شناسایی قابل‌سوءاستفاده بودن آسیب‌پذیری‌ها
- **Role_ID:** EXE-039
...
- **PrimaryOwner:** Penetration Tester
...
- **ConsumerPersonas:** AppSec, Security Architect
...
- **Project lifecycle (از دادهٔ نقش):** Testing, Reporting
...
- **Functional:** - Evidence/Reproducibility
- **Technical (مختص این نقش):** - تعریف scope/rules/authorization
- اجرای reconnaissance/testing/exploitation
- مستندسازی evidence/severity/repro
- تعریف report و همکاری با remediation
...
- **Plan Path:** `audits/penetration-tester-execution-plan.md` (اگر وجود دارد)
