...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-025
...
- **ConsumerPersonas:** Accessibility Specialist، Agent Evaluator، Beta Tester، Load/Stress Tester، QA Engineer، Release Engineer، Test Automation Engineer، Test Engineer
...
- **EscalationConditions:** Critical Quality Risk
...
- **Project lifecycle (از دادهٔ نقش):** Planning, Testing, Sign-off
...
- محورهای خاص این نقش: - پوشش استراتژی تست و آمادگی تیم
- کیفیت متدولوژی/ابزار/ماتریس Coverage
- انطباق انتظارات QA با اهداف محصول
- First pass on Defect/Report و trend

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/qa-lead-execution-plan.md` ذخیره شود.
