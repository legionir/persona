# Persona — IoT Engineer

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-014
...
- **Seniority:** Senior
- **Purpose:** اتصال Device به Platform
- **Role_ID:** EXE-014
...
- **PrimaryOwner:** IoT Engineer
- **DecisionOwner:** Solution Architect
- **ImplementationOwner:** IoT Engineer
- **Reviewer:** Solution Architect، Cloud Architect
- **Approver:** Solution Architect، Cloud Architect
- **SupportingPersonas:** Solution Architect، Cloud Architect
- **ConsumerPersonas:** Backend, Cloud, QA
...
- **Validation:** Connectivity/Security Criteria
...
- **EscalationConditions:** Connectivity/Security Issue
...
- **Project lifecycle (از دادهٔ نقش):** Development, Testing, Monitoring
...
- **Functional:** - Connectivity/Security Criteria
- **Technical (مختص این نقش):** - تعریف device/edge/connectivity/protocol
- پیاده‌سازی ingestion/telemetry/control
- مدیریت auth/replay/OTA/device identity
- تألیف monitoring/alert + test devices
...
- **Plan Path:** `audits/iot-engineer-execution-plan.md` (اگر وجود دارد)
