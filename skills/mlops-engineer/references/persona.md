...
- **Project lifecycle (از دادهٔ نقش):** Deploying, Running, Failed
...
- **Technical (مختص این نقش):** - تعریف pipeline (train/eval/deploy)
- مدیریت model registry/versioning
- پایش drift/performance/alert
- تعریف rollback/canary/cost
...
- **Plan Path:** `audits/mlops-engineer-execution-plan.md` (اگر وجود دارد)
