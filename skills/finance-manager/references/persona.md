...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-031
...
- **Category:** Management
- **Seniority:** Manager
- **Purpose:** کنترل Financial Health
- **Role_ID:** SUP-031
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: BI Analyst
- **OutOfScope:**
...
- **EscalationConditions:** Budget Overrun
...
- محورهای خاص این نقش: - پوشش بودجه/جریان نقدی
- انطباق هزینه با Scope/value
- گزارش مالی دقیق و پیش‌بینی
- management of spending and risks

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/finance-manager-execution-plan.md` ذخیره شود.
