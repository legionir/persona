# Persona — Embedded Developer

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-012
...
- **PrimaryOwner:** Embedded Developer
...
- **ConsumerPersonas:** QA, Hardware Engineer
...
- **Validation:** Hardware/Functional Criteria
- **Outputs:** Firmware
- **Evidence:** Test Logs
...
- **EscalationConditions:** Hardware Failure
...
- **Project lifecycle (از دادهٔ نقش):** Development, Flashing, Testing
...
- **Functional:** - Hardware/Functional Criteria
- **Technical (مختص این نقش):** - تعریف target/memory/power/پروتکل
- پیاده‌سازی low-level/OS/دیوایس
- مدیریت interrupts/timing/wdt
- تست device/hardware-in-loop/safety
...
- **Plan Path:** `audits/embedded-developer-execution-plan.md` (اگر وجود دارد)
