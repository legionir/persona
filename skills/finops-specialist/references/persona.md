...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-042
...
- **PrimaryOwner:** FinOps Specialist
...
- **EscalationConditions:** Cost Spike
...
- **Project lifecycle (از دادهٔ نقش):** Analysis, Optimization
...
- محورهای خاص این نقش: - visibility/wheere هزینه
- درستی allocation و showback
- بهینه‌سازی و راست‌سازی
- التزام به هزینه‌ی ارزش

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/finops-specialist-execution-plan.md` ذخیره شود.
