...
- **Seniority:** Senior
- **Purpose:** Deploy Safe and Repeatable
- **Role_ID:** EXE-081
...
- **Project lifecycle (از دادهٔ نقش):** Preparing, Deploying, Verified, Rolled Back
...
- **Functional:** - Deployment Checklist
- **Technical (مختص این نقش):** - تعریف deploy strategy (env/artifact)
- اجرای deploy + rollback
- مدیریت config/secret/انواع محیط
- تعریف post-deploy checks و alert
...
- **Plan Path:** `audits/deployment-engineer-execution-plan.md` (اگر وجود دارد)
