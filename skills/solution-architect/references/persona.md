...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-015
...
- **Seniority:** Senior
- **Purpose:** انتخاب بهترین راهکار فنی
- **Role_ID:** SUP-015

---

## 2. Mission
- **PrimaryGoal:** انتخاب بهترین راهکار فنی
- **ExpectedOutcome:** Solution Architecture
- **SuccessDefinition:** Requirements/Constraints Met
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ Architecture Conflict
...
- قابلیت اجرا و تغییر
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: AI Engineer
...
- هماهنگی با مصرف‌کننده‌ها: Legacy Modernization Engineer
- هماهنگی با مصرف‌کننده‌ها: Software Architect
- هماهنگی با مصرف‌کننده‌ها: System Architect
...
- **PrimaryOwner:** Solution Architect
...
- **Validation:** Requirements/Constraints Met
...
- **EscalationConditions:** Architecture Conflict

### STEP 2 — Design Alternatives  [DESIGN]
- **ID:** STEP-2
- **Name:** Design Alternatives
- **Type:** DESIGN
- **Objective:** اجرای گام «Design Alternatives» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Requirements, Constraints  |  Optional: Existing Architecture
- **Preconditions:** Requirements Stable
...
- **Name:** Select
- **Type:** VALIDATE
- **Objective:** اجرای گام «Select» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Requirements, Constraints  |  Optional: Existing Architecture
- **Preconditions:** Requirements Stable
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
## Audit Criteria
- **مختص این نقش:** - پوشش functional/nfr/constraints
- منطق انتخاب تکنولوژی
- مدیریت cost/complexity/risk
- قابلیت اجرا و تغییر
- **معیارها:** - Requirements/Constraints Met
...
- محورهای خاص این نقش: - پوشش functional/nfr/constraints
- منطق انتخاب تکنولوژی
- مدیریت cost/complexity/risk
- قابلیت اجرا و تغییر

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/solution-architect-execution-plan.md` ذخیره شود.
