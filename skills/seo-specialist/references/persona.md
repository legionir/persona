...
- **Purpose:** افزایش Organic Acquisition
- **Role_ID:** EXE-066
...
- **ConsumerPersonas:** Marketing, Engineering
...
- **Validation:** SEO Criteria
- **Outputs:** SEO Changes, Reports
...
- **EscalationConditions:** Technical SEO Risk
...
- **Project lifecycle (از دادهٔ نقش):** Auditing, Optimization
...
- **Functional:** - SEO Criteria
- **Technical (مختص این نقش):** - تعریف keyword/topic model و site structure
- بهینه‌سازی on-page/technical/structured data
- مدل linking/internal/silha
- گزارش rank/organic/conversion
...
- **Plan Path:** `audits/seo-specialist-execution-plan.md` (اگر وجود دارد)
