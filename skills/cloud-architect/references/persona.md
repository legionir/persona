...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-024
...
- **Supporting:**
- هماهنگی با مصرف‌کننده‌ها: Cloud Engineer
...
- هماهنگی با مصرف‌کننده‌ها: IoT Engineer
...
- **Validation:** Cost/Reliability/Security
- **Outputs:** Cloud Architecture
...
- **EscalationConditions:** Architectural Risk
...
- محورهای خاص این نقش: - انتخاب خدمات و معماری متناسب با workload
- مدیریت امنیت/هویت/شبکه در کلود
- مقیاس پذیری/قابلیت بازیابی/هزینه
- سازگاری با استراتژی Multi-Cloud/On-prem

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/cloud-architect-execution-plan.md` ذخیره شود.
