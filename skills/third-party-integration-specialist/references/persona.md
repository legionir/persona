# Persona — Third-party Integration Specialist

> **نوع:** EXECUTOR  |  **Role_ID:** EXE-079
...
- **PrimaryOwner:** Third-party Integration Specialist
...
- **Validation:** Contract/Security Criteria
- **Outputs:** Integration Code, Tests
...
- **EscalationConditions:** API Breaking Change
...
- **Project lifecycle (از دادهٔ نقش):** Development, Testing, Live
...
- **Functional:** - Contract/Security Criteria
- **Technical (مختص این نقش):** - تعریف contract/auth/timeout
- پیاده‌سازی integration with validation
- مدیریت rate/retry/circuit/fallback
- تست integration/mock + secrets
...
- **Plan Path:** `audits/third-party-integration-specialist-execution-plan.md` (اگر وجود دارد)
