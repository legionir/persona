...
- **Supporting:**
- هماهنگی با ناظر: Localization Manager
- **OutOfScope:**
...
- **PrimaryOwner:** Translator
- **DecisionOwner:** Localization Manager
- **ImplementationOwner:** Translator
- **Reviewer:** Localization Manager
- **Approver:** Localization Manager
- **SupportingPersonas:** Localization Manager
- **ConsumerPersonas:** Localization
...
- **Validation:** Accuracy/Terminology
...
- **EscalationConditions:** Ambiguous Source
...
- **Project lifecycle (از دادهٔ نقش):** Translating, Review
...
- **Functional:** - Accuracy/Terminology
- **Technical (مختص این نقش):** - تعریف glossary و tone per language
- ترجمه منبع/Terminology/به شکل یکدست
- بازبینی contextual و QA
- نگهداری version/update translation
...
- **Plan Path:** `audits/translator-execution-plan.md` (اگر وجود دارد)
