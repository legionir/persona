...
- **EscalationConditions:** Critical Defect
...
- **Project lifecycle (از دادهٔ نقش):** Testing, Blocked, Passed
...
- **Technical (مختص این نقش):** - طراحی Test Plan/MasterTest/خودکار
- نوشتن Test Cases با steps/expected/evidence
- تعریف Regression suite نسخه‌ها
- تعریف defect lifecycle و report
...
- **Plan Path:** `audits/qa-engineer-execution-plan.md` (اگر وجود دارد)
