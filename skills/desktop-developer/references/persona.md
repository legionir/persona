...
- **Seniority:** Mid
- **Purpose:** تولید Desktop Application
- **Role_ID:** EXE-010
...
- **PrimaryOwner:** Desktop Developer
- **DecisionOwner:** Technical Lead / Tech Lead
- **ImplementationOwner:** Desktop Developer
- **Reviewer:** Technical Lead / Tech Lead
- **Approver:** Technical Lead / Tech Lead
- **SupportingPersonas:** Technical Lead / Tech Lead
- **ConsumerPersonas:** QA, Release
...
- **Validation:** Functional/Platform Criteria
...
- **EscalationConditions:** OS Compatibility Issue
...
- **Project lifecycle (از دادهٔ نقش):** Development, Testing
...
- **Functional:** - Functional/Platform Criteria
- **Technical (مختص این نقش):** - تعریف architecture/state/data
- پیاده‌سازی UI + system integration
- مدیریت file/update/تماس/context
- تست multi-platform + performance + signatures
...
- **Plan Path:** `audits/desktop-developer-execution-plan.md` (اگر وجود دارد)
