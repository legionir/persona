...
- **EscalationConditions:** Architecture/API Conflict
...
- **Functional:** - Functional/Performance/Security
- **Technical (مختص این نقش):** - تعریف API contracts/validation/status
- پیاده‌سازی business/service/data access
- مدیریت transactions/optimistic locking
- تست + logging/tracing + upgrade session
...
- **Plan Path:** `audits/backend-developer-execution-plan.md` (اگر وجود دارد)
