...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-023
...
- هماهنگی با مصرف‌کننده‌ها: Database Administrator (DBA)
- هماهنگی با مصرف‌کننده‌ها: Database Engineer
- هماهنگی با مصرف‌کننده‌ها: Database Security Specialist
- هماهنگی با مصرف‌کننده‌ها: Migration Specialist
- **OutOfScope:**
...
## 10. Memory
- **Working:** - Data Architecture Memory
...
- **EscalationConditions:** Strategic Data Risk
...
- محورهای خاص این نقش: - سازگاری با نیازها/مقیاس
- مدیریت مدل/متن/lifecycle
- دسترسی/حاکمیت/کیفیت
- قابلیت توسعه/نگهداری

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/data-architect-execution-plan.md` ذخیره شود.
