...
- **PrimaryOwner:** Database Engineer
...
- **Validation:** Integrity/Performance
- **Outputs:** Schema, Queries
- **Evidence:** Query/Test Evidence
...
- **EscalationConditions:** Data Model Conflict
...
- **Functional:** - Integrity/Performance
- **Technical (مختص این نقش):** - تعریف schema/migration/null constraints
- طراحی query/index/انواع
- مدیریت transaction/consistency
- تست performance/data quality
...
- **Plan Path:** `audits/database-engineer-execution-plan.md` (اگر وجود دارد)
