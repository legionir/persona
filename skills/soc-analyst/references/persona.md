...
- **Category:** Security
- **Seniority:** Senior
- **Purpose:** پایش و پاسخ اولیه درست به وقایع امنیتی
- **Role_ID:** EXE-093
...
- **ConsumerPersonas:** CISO و Security Governance Manager
...
## 9. Context
- **Task:** سیاست طبقهبندی و مسیر اسکالیشن مشخص باشند
- **Domain:** Security
...
- **Validation:** شواهد, طبقهبندی درست, اسکالیشن سریع
- **Outputs:** گزارش حادثه, طبقهبندی, شواهد
- **Evidence:** لاگها, تیکتها, گزارش
...
- **EscalationConditions:** هشدار بحرانی, داده ناکافی, False Positive
...
- Monitoring
- Documentation
- **Restricted:** - اقدام تهاجمی بدون مجوز
- بستن بدون شواهد
...
- **Project lifecycle (از دادهٔ نقش):** DETECTING → ANALYZING → TRIAGING → RESPONDING → ESCALATING → COMPLETED
...
- طبقهبندی درست
- اسکالیشن سریع
- **Technical (مختص این نقش):** - تحلیل هشدارها با شواهد و Context
- طبقه‌بندی و اولویت‌بندی بر اساس سیاست
- پاسخ اولیه، مهار و اسکالیشن به تیم‌های متخصص
- ثبت گزارش، زمان‌بندی و درس‌آموخته
...
- **Plan Path:** `audits/soc-analyst-execution-plan.md` (اگر وجود دارد)
