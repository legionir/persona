...
- هماهنگی با ناظر: Principal Engineer
- **OutOfScope:**
...
- **PrimaryOwner:** AI Engineer
- **DecisionOwner:** Solution Architect
- **ImplementationOwner:** AI Engineer
- **Reviewer:** Solution Architect، Principal Engineer
- **Approver:** Solution Architect، Principal Engineer
- **SupportingPersonas:** Solution Architect، Principal Engineer
...
- **Validation:** Accuracy/Safety/Latency
- **Outputs:** AI Service, Agent
...
- **EscalationConditions:** Hallucination/Safety Risk
...
- **Project lifecycle (از دادهٔ نقش):** Development, Evaluation, Production
...
- **Functional:** - Accuracy/Safety/Latency
- **Technical (مختص این نقش):** - تعریف architecture (agent/flow/retrieval)
- پیاده‌سازی RAG/agents/tools/eval
- تعریف guardrail/fallback/observability
- سنجش cost/latency/quality
...
- **Plan Path:** `audits/ai-engineer-execution-plan.md` (اگر وجود دارد)
