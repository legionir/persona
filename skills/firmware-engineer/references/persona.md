...
- **Seniority:** Senior
- **Purpose:** کنترل Hardware از طریق Firmware
- **Role_ID:** EXE-013
...
- **PrimaryOwner:** Firmware Engineer
...
- **ConsumerPersonas:** Embedded Lead
...
- **Outputs:** Firmware Binary, Source
- **Evidence:** Logs
...
- **EscalationConditions:** Hardware Risk
...
- **Technical (مختص این نقش):** - تعریف device/register/memory map
- پیاده‌سازی driver/protocol/startup
- مدیریت boot/update/watchdog
- تست hardware + OTA + safety
...
- **Plan Path:** `audits/firmware-engineer-execution-plan.md` (اگر وجود دارد)
