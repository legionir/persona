...
- **Supporting:**
- هماهنگی با ناظر: HR / People Manager
- **OutOfScope:**
...
- **PrimaryOwner:** Recruiter
- **DecisionOwner:** HR / People Manager
- **ImplementationOwner:** Recruiter
- **Reviewer:** HR / People Manager
- **Approver:** HR / People Manager
- **SupportingPersonas:** HR / People Manager
- **ConsumerPersonas:** HR, Hiring Manager
...
- **API:**
- سازگاری ساختار نقش/تیم با سازمان
- **Data:**
- حریم دادهٔ افراد
- **Security:**
- حریم دادهٔ افراد
...
- **EscalationConditions:** Hiring Difficulty
...
- **Project lifecycle (از دادهٔ نقش):** Sourcing, Screening
...
- **Functional:** - Hiring Criteria
- **Technical (مختص این نقش):** - تعریف job description/sourcing/список
- مصاحبه/ارزیابی/اسکور با معیار
- بهبود pipeline و candidate experience
- مدیریت داده‌ها/حریم و حقوقی
...
- **Plan Path:** `audits/recruiter-execution-plan.md` (اگر وجود دارد)
