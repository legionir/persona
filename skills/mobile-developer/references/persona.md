...
- **Seniority:** Mid
- **Purpose:** پیاده‌سازی Mobile Product
- **Role_ID:** EXE-009
...
- **Validation:** Platform Criteria
- **Outputs:** Mobile Build
...
- **EscalationConditions:** Platform Blocker
...
- **Project lifecycle (از دادهٔ نقش):** Development, Testing, Release
...
- **Technical (مختص این نقش):** - تعریف navigate/state/persistence
- پیاده‌سازی UI/platform compliance
- مدیریت offline/network/permission/notification
- تست device/server + code signature/release
...
- **Plan Path:** `audits/mobile-developer-execution-plan.md` (اگر وجود دارد)
