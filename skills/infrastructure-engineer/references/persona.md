...
- **Seniority:** Senior
- **Purpose:** تأمین Infrastructure پایدار
- **Role_ID:** EXE-026
...
- هماهنگی با ناظر: Platform Owner
- **OutOfScope:**
...
- **EscalationConditions:** Infrastructure Failure
...
- **Project lifecycle (از دادهٔ نقش):** Provisioning, Maintenance
...
- **Technical (مختص این نقش):** - تعریف استاندارد Provisioning/Configuration
- پیاده‌سازی پایش/پچ/امنیت و hardening
- برنامه‌ریزی ظرفیت و auto-scaling
- تعریف backup/HA/DR infra و test
...
- **Plan Path:** `audits/infrastructure-engineer-execution-plan.md` (اگر وجود دارد)
