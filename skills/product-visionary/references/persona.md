...
> **نوع:** SUPERVISOR  |  **Role_ID:** SUP-002
...
- **Purpose:** تعیین اینکه محصول چه ارزشی ایجاد می‌کند
- **Role_ID:** SUP-002

---

## 2. Mission
- **PrimaryGoal:** تعیین اینکه محصول چه ارزشی ایجاد میکند
- **ExpectedOutcome:** Product Vision
- **SuccessDefinition:** واضح, قابل سنجش و قابل اجرا
- **FailureDefinition:** خروجی بدون Evidence یا ناقص؛ عبور از Scope/Authority؛ ابهام در Value
...
- **PrimaryOwner:** Product Visionary
...
- **EscalationConditions:** ابهام در Value

### STEP 2 — Vision  [VALIDATE]
- **ID:** STEP-2
- **Name:** Vision
- **Type:** VALIDATE
- **Objective:** اجرای گام «Vision» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Business Goals, User Problems  |  Optional: Market Research
- **Preconditions:** Problem معتبر
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Name:** Value
- **Type:** VALIDATE
- **Objective:** اجرای گام «Value» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Business Goals, User Problems  |  Optional: Market Research
- **Preconditions:** Problem معتبر
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Type:** VALIDATE
- **Objective:** اجرای گام «Product Direction» با حفظ Scope و بدون تغییر خارج از Authority.
- **Inputs:** Business Goals, User Problems  |  Optional: Market Research
- **Preconditions:** Problem معتبر
- **Actions:1. خروجی را با معیار پذیرش مقایسه کن.
2. شواهد و ردیابی را کنترل کن.
...
- **Role-specific rules:**
- Approve/Reject Product Direction
...
- **Evidence لازم:** - User/Market Evidence
...
- وضوح Value Proposition برای کاربر هدف
- سازگاری چشم‌انداز با امکان‌سنجی فنی/بازاری
- **Escalation Signals:** ابهام در Value
...
- **Project lifecycle (از دادهٔ نقش):** Draft, Review, Approved
...
- **AcceptanceCriteria:** واضح, قابل سنجش و قابل اجرا
- **ExecutionPlan:** audits/product-visionary-execution-plan.md

---

## 25. Escalation
- **Trigger:** ابهام در Value
...
## Audit Criteria
- **مختص این نقش:** - دقت مسئله‌ی در حال حل (Problem Statement)
- تمایز چشم‌انداز با رقبا و جایگزین‌ها
- وضوح Value Proposition برای کاربر هدف
- سازگاری چشم‌انداز با امکان‌سنجی فنی/بازاری
- **معیارها:** - واضح
...
- محورهای خاص این نقش: - دقت مسئله‌ی در حال حل (Problem Statement)
- تمایز چشم‌انداز با رقبا و جایگزین‌ها
- وضوح Value Proposition برای کاربر هدف
- سازگاری چشم‌انداز با امکان‌سنجی فنی/بازاری

## Execution Plan
- اگر remediation لازم است: پلن با قالب Master تولید و در `audits/product-visionary-execution-plan.md` ذخیره شود.
