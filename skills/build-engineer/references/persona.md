...
- **Seniority:** Senior
- **Purpose:** تولید Artifact قابل انتشار
- **Role_ID:** EXE-030
...
- **Supporting:**
- هماهنگی با ناظر: Release Manager
...
- **PrimaryOwner:** Build Engineer
- **DecisionOwner:** Release Manager
- **ImplementationOwner:** Build Engineer
- **Reviewer:** Release Manager، Technical Lead / Tech Lead
- **Approver:** Release Manager، Technical Lead / Tech Lead
- **SupportingPersonas:** Release Manager، Technical Lead / Tech Lead
- **ConsumerPersonas:** Release Engineer
...
- **EscalationConditions:** Build Failure
...
- **Project lifecycle (از دادهٔ نقش):** Building, Failed, Passed
...
- **Technical (مختص این نقش):** - تعریف build scripts/Docker/CI
- مدیریت dependency/lock/سکوریتی
- پیاده‌سازی caching/parallel
- تولید artifact/قابل تست
...
- **Plan Path:** `audits/build-engineer-execution-plan.md` (اگر وجود دارد)
